...
|---|---:|
| Tracked files | 7,252 |
| Total bytes | 70,673,335 |
| Counted text lines | 1,656,900 |
| Directories | 266 |
| Categories | 13 |
...
| `http-generic-api/remote-mcp-write-scope-inventory.generated.json` | api-runtime | 1,936,154 | 58552 |
