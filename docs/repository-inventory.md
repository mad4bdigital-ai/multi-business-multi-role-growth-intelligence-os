...
|---|---:|
| Tracked files | 7,084 |
| Total bytes | 67,830,141 |
| Counted text lines | 1,588,618 |
| Directories | 265 |
| Categories | 13 |
...
| `package.json` | `multi-business-growth-intelligence-os` | `1.0.0` | 23 | 0 | 4 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,440,635 | 97402 |
