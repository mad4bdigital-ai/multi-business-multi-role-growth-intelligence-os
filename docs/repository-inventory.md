...
|---|---:|
| Tracked files | 7,177 |
| Total bytes | 69,964,915 |
| Counted text lines | 1,643,043 |
| Directories | 266 |
| Categories | 13 |
...
| `docs/governance/configuration-drift-policy.json` | documentation | 252,278 | 2184 |
