...
|---|---:|
| Tracked files | 7,114 |
| Total bytes | 68,916,346 |
| Counted text lines | 1,616,159 |
| Directories | 265 |
| Categories | 13 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,448,635 | 97587 |
