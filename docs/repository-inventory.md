...
|---|---:|
| Tracked files | 7,199 |
| Total bytes | 70,264,075 |
| Counted text lines | 1,649,436 |
| Directories | 266 |
| Categories | 13 |
...
| `docs/governance/configuration-drift-policy.json` | documentation | 257,408 | 2242 |
