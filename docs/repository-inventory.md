...
|---|---:|
| Tracked files | 7,300 |
| Total bytes | 71,312,843 |
| Counted text lines | 1,668,928 |
| Directories | 266 |
| Categories | 13 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,482,178 | 98220 |
...
| `http-generic-api/openapi.yaml` | api-contracts | 997,114 | 23114 |
...
| `specs/020-platform-resource-identity-brand-governance/openapi-gap-closure-plan.json` | api-contracts | 270,771 | 6428 |
