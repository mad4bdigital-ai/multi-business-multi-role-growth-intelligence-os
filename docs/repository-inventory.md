...
|---|---:|
| Tracked files | 7,216 |
| Total bytes | 70,404,116 |
| Counted text lines | 1,652,222 |
| Directories | 266 |
| Categories | 13 |
...
| `docs/governance/configuration-drift-policy.json` | documentation | 261,504 | 2290 |
