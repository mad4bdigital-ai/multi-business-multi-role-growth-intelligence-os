...
|---|---:|
| Tracked files | 7,399 |
| Total bytes | 72,822,427 |
| Counted text lines | 1,695,133 |
| Directories | 266 |
| Categories | 13 |
...
| Category | Files |
|---|---:|
| `tests-and-specs` | 2,191 |
| `documentation` | 1,914 |
| `api-runtime` | 1,509 |
| `database-migrations` | 815 |
| `root-and-other` | 334 |
| `api-contracts` | 192 |
| `ci-workflows` | 170 |
| `ci-config` | 135 |
...
| `http-generic-api/remote-mcp-write-scope-inventory.generated.json` | api-runtime | 1,960,980 | 59303 |
