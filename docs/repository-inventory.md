...
|---|---:|
| Tracked files | 6,720 |
| Total bytes | 58,996,490 |
| Counted text lines | 1,376,766 |
| Directories | 255 |
| Categories | 13 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,161,185 | 97073 |
