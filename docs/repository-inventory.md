...
|---|---:|
| Tracked files | 7,109 |
| Total bytes | 68,862,358 |
| Counted text lines | 1,615,280 |
| Directories | 265 |
| Categories | 13 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,448,637 | 97587 |
