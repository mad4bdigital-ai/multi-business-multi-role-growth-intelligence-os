...
|---|---:|
| Tracked files | 7,179 |
| Total bytes | 69,998,628 |
| Counted text lines | 1,643,641 |
| Directories | 266 |
| Categories | 13 |
...
| `http-generic-api/remote-mcp-write-scope-inventory.generated.json` | api-runtime | 1,936,117 | 58551 |
...
| `docs/governance/configuration-drift-policy.json` | documentation | 253,238 | 2196 |
