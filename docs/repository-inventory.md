...
|---|---:|
| Tracked files | 7,053 |
| Total bytes | 66,016,569 |
| Counted text lines | 1,553,007 |
| Directories | 263 |
| Categories | 13 |
...
| `http-generic-api/frontend-surface-dispatch.generated.json` | api-runtime | 3,123,848 | 95802 |
...
| `specs/020-platform-resource-identity-brand-governance/openapi-gap-closure-plan.json` | api-contracts | 262,417 | 6360 |
