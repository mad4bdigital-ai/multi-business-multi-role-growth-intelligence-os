...
- Documentation complete migrations: 511/512 (99.80%)
...
|---|---:|
| no_provider_call | 511 |
| no_credential_payload_read | 511 |
| no_raw_secrets | 511 |
| no_external_send | 511 |
| no_external_write | 512 |
| secrets_included_false | 511 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| `20260713_local_manager_desktop_command_mutation_policy.sql` | high_review | 536 | medium | 5 | 0 | 5 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
