...
- Migrations with detected surfaces: 472
...
- Documentation complete migrations: 471/472 (99.79%)
...
|---|---:|---:|---:|---:|---:|---:|---|
| `20260701_repository_operation_leases.sql` | high_review | 580 | medium | 5 | 0 | 3 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
