...
|---|---:|---:|---:|---:|---:|---:|---|
| `20260704_runtime_dispatch_certification_issuer.sql` | high_review | 587 | medium | 5 | 0 | 2 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
