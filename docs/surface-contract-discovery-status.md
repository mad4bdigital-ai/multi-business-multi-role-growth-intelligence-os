...
- Migrations with detected surfaces: 537
- Migrations reported here: 80
- OpenAPI operations detected: 1016
- OpenAPI paths detected: 933
...
- Documentation complete migrations: 512/537 (95.34%)
- Documentation gap migrations: 25
- Gap severity: high=15, medium=10, low=0
- SQL route coverage in OpenAPI: 20/22 (90.91%)
- SQL route-like literals exempted from OpenAPI scoring: 661/683
...
|---|---:|
| `Updating Registry Patch Index.md` | 23 |
| `deployment_parity_checklist.md` | 23 |
| `docs/ai-docs-agent-governance.md` | 23 |
| `docs/auto-docs-agent/README.md` | 25 |
| `docs/change-documentation-governance.md` | 25 |
...
| `20260717_virtual_tool_capability_projection.sql` | critical_review | 742 | medium | 2 | 0 | 5 | document_surface_contract, verify_tool_registry_binding, verify_readback_view, add_explicit_safety_markers |
...
| `20260717_virtual_tool_readback_readiness.sql` | high_review | 564 | medium | 2 | 0 | 5 | document_surface_contract, verify_tool_registry_binding, verify_readback_view, add_explicit_safety_markers |
