...
- Migrations with detected surfaces: 421
...
- Documentation complete migrations: 419/421 (99.52%)
- Documentation gap migrations: 2
- Gap severity: high=1, medium=1, low=0
- SQL route coverage in OpenAPI: 1/1 (100.00%)
- SQL route-like literals exempted from OpenAPI scoring: 553/554
...
|---|---:|---:|---:|---:|---:|---:|---|
| `313_sprint69_capability_assurance_graph.sql` | critical_review | 1141 | high | 5 | 0 | 4 | document_surface_contract, verify_tool_registry_binding, verify_policy_seed_readiness, verify_readback_view, add_explicit_safety_markers |
...
| `313_sprint69_capability_assurance_graph.sql` | needs docs | high | 0 | 10 | 8 | 1 | 1 | 0 |
...
- `313_sprint69_capability_assurance_graph.sql`
