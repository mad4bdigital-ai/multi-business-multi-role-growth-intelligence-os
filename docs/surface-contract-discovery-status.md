...
- Migrations with detected surfaces: 487
...
- Documentation complete migrations: 486/487 (99.79%)
...
|---|---:|
| no_provider_call | 487 |
| no_credential_payload_read | 486 |
| no_raw_secrets | 487 |
| no_external_send | 487 |
| no_external_write | 487 |
| secrets_included_false | 487 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| `1036_sprint69_governance_debt_cleanup.sql` | high_review | 652 | high | 5 | 0 | 1 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
...
- `1036_sprint69_governance_debt_cleanup.sql`
