...
- Documentation complete migrations: 485/486 (99.79%)
...
|---|---:|
| no_provider_call | 486 |
| no_credential_payload_read | 486 |
| no_raw_secrets | 485 |
| no_external_send | 485 |
| no_external_write | 486 |
| secrets_included_false | 486 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| `1036_sprint69_capability_enablement_virtual_admin_tool_bridge.sql` | high_review | 536 | medium | 5 | 0 | 2 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
