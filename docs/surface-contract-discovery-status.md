...
- Documentation complete migrations: 468/477 (98.11%)
- Documentation gap migrations: 9
- Gap severity: high=4, medium=1, low=4
...
| `docs/ai-docs-agent-governance.md` | 9 |
| `docs/auto-docs-agent/README.md` | 9 |
