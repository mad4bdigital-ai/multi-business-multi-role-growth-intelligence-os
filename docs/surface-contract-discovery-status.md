...
- Migrations with detected surfaces: 450
...
- Documentation complete migrations: 449/450 (99.78%)
...
|---|---:|---:|---:|---:|---:|---:|---|
| `1023_sprint69_github_rest_endpoint_dispatch_foundation.sql` | critical_review | 1039 | high | 5 | 0 | 5 | document_surface_contract, verify_tool_registry_binding, add_explicit_safety_markers |
