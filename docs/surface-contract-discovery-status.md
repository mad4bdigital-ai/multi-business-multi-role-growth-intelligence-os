...
| no_credential_payload_read | 447 |
| no_raw_secrets | 447 |
| no_external_send | 447 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| `1020_sprint69_multi_surface_tenant_agent_runtime.sql` | low_review | 165 | none | 0 | 0 | 3 | verify_tool_registry_binding, verify_readback_view, add_explicit_safety_markers |
