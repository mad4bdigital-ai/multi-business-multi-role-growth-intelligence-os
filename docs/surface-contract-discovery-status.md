...
| `909_sprint68_ticket_external_dynamic_recipient_allowlist.sql` | needs docs | 0 | 2 | 1 | 1 | 0 |
| `908_sprint68_ticket_external_hostinger_gmail_provider_options.sql` | needs docs | 0 | 9 | 0 | 1 | 0 |
| `907_sprint68_ticket_external_live_smtp_registry_alignment.sql` | needs docs | 0 | 6 | 0 | 1 | 0 |
| `906_sprint68_ticket_external_delivery_completion_certification.sql` | needs docs | 1 | 13 | 0 | 3 | 1 |
| `905_sprint68_support_ticket_lifecycle_snapshot_apply_policy_readback_alignment.sql` | needs docs | 0 | 9 | 0 | 1 | 0 |
| `904_sprint68_support_ticket_lifecycle_snapshot_apply_binding.sql` | needs docs | 0 | 17 | 0 | 1 | 0 |
...
| `284_sprint68_session_insight_backlog_target_write_executor.sql` | needs docs | 0 | 14 | 2 | 1 | 3 |
| `284_sprint68_execution_log_full_context_evidence.sql` | needs docs | 0 | 1 | 2 | 1 | 0 |
| `283_sprint68_session_insight_capability_envelope_remaining_scope_completion.sql` | needs docs | 0 | 36 | 2 | 1 | 2 |
| `282_sprint68_session_insight_capability_envelope_adapter_execution_gate.sql` | needs docs | 0 | 47 | 2 | 1 | 2 |
| `281_sprint68_session_insight_capability_envelope_dispatch_readback.sql` | needs docs | 0 | 43 | 2 | 1 | 2 |
| `280_sprint68_session_insight_capability_envelope_approval_gate.sql` | needs docs | 0 | 35 | 2 | 1 | 2 |
| `279_sprint68_session_insight_capability_envelope_actual_request_dispatch.sql` | needs docs | 0 | 52 | 2 | 1 | 2 |
| `278_sprint68_session_insight_capability_envelope_actual_request_preflight.sql` | needs docs | 0 | 40 | 2 | 1 | 2 |
| `277_sprint68_session_insight_capability_envelope_dispatch_dry_run_review.sql` | needs docs | 0 | 37 | 3 | 1 | 1 |
| `277_sprint68_execution_log_runtime_evidence.sql` | needs docs | 0 | 1 | 2 | 1 | 0 |
| `276_sprint68_activation_positive_surface_fixtures.sql` | needs docs | 0 | 1 | 1 | 0 | 0 |
| `275_sprint68_session_insight_capability_envelope_dispatch_dry_run.sql` | needs docs | 0 | 31 | 2 | 1 | 2 |
| `274_sprint68_session_insight_capability_envelope_request_review.sql` | needs docs | 0 | 30 | 3 | 1 | 1 |
| `274_sprint68_schema_split_importer_v2_reference_preservation.sql` | needs docs | 0 | 0 | 0 | 0 | 1 |
| `274_sprint68_execution_policy_enforcement_closure.sql` | needs docs | 1 | 13 | 0 | 1 | 0 |
| `273_sprint68_support_ticket_lifecycle_snapshot_record_gate.sql` | needs docs | 0 | 6 | 0 | 1 | 1 |
| `273_sprint68_session_insight_capability_envelope_request_gate.sql` | needs docs | 0 | 39 | 3 | 1 | 2 |
| `273_sprint68_activation_catalog_authorized_surfaces.sql` | needs docs | 0 | 9 | 14 | 0 | 0 |
| `272_sprint68_ticket_external_provider_gate_registry_resolver.sql` | needs docs | 0 | 6 | 0 | 1 | 0 |
| `272_sprint68_support_ticket_lifecycle_snapshot_proposal.sql` | needs docs | 0 | 4 | 0 | 1 | 1 |
| `272_sprint68_session_insight_capability_envelope_planner.sql` | needs docs | 0 | 12 | 3 | 1 | 2 |
| `271_sprint68_session_insight_adapter_apply_readiness_gate.sql` | needs docs | 0 | 24 | 2 | 1 | 1 |
| `271_sprint68_activation_expanded_authorized_surfaces.sql` | needs docs | 0 | 3 | 9 | 0 | 0 |
| `270_sprint68_support_ticket_lifecycle_orchestration_readback.sql` | needs docs | 2 | 18 | 2 | 4 | 0 |
| `270_sprint68_session_insight_payload_preview_review.sql` | needs docs | 0 | 10 | 2 | 1 | 2 |
| `270_sprint68_dynamic_capability_tool_bus_kernel.sql` | needs docs | 0 | 9 | 1 | 0 | 2 |
| `269_sprint68_ticket_external_adapter_future_pr_scope.sql` | needs docs | 0 | 12 | 1 | 1 | 2 |
| `269_sprint68_session_insight_contract_payload_preview.sql` | needs docs | 0 | 11 | 3 | 1 | 1 |
| `269_sprint68_activation_authorized_surface_registry.sql` | needs docs | 0 | 1 | 1 | 0 | 0 |
| `268_sprint68_ticket_external_adapter_readiness_decision.sql` | needs docs | 0 | 20 | 1 | 1 | 1 |
| `268_sprint68_session_insight_adapter_dry_run_contracts.sql` | needs docs | 0 | 12 | 3 | 1 | 1 |
| `267_sprint68_ticket_external_adapter_readiness_checklist.sql` | needs docs | 0 | 9 | 1 | 1 | 2 |
| `267_sprint68_session_insight_target_adapter_registry.sql` | needs docs | 0 | 17 | 2 | 1 | 1 |
| `266_sprint68_ticket_external_provider_enablement_proposal.sql` | needs docs | 0 | 10 | 1 | 1 | 2 |
| `266_sprint68_session_insight_promotion_apply_request_skeleton.sql` | needs docs | 0 | 20 | 1 | 1 | 1 |
| `265_sprint68_ticket_external_provider_adapter_contracts.sql` | needs docs | 0 | 12 | 1 | 1 | 1 |
| `265_sprint68_session_insight_promotion_dry_run_executor.sql` | needs docs | 0 | 2 | 1 | 1 | 1 |
| `265_sprint68_platform_orchestration_capability_binding.sql` | needs docs | 0 | 12 | 0 | 0 | 0 |
| `264_sprint68_ads_governance_snapshot_record_gate.sql` | needs docs | 0 | 4 | 0 | 1 | 1 |
| `263_sprint68_session_insight_promotion_review_tools.sql` | needs docs | 0 | 4 | 1 | 1 | 2 |
| `263_sprint68_ads_governance_snapshot_proposal.sql` | needs docs | 0 | 2 | 0 | 1 | 1 |
| `262_sprint68_ticket_external_send_provider_gate.sql` | needs docs | 0 | 3 | 0 | 0 | 2 |
| `262_sprint68_orchestration_readback_surface.sql` | needs docs | 1 | 11 | 2 | 1 | 1 |
| `261_sprint68_ticket_external_credential_orchestration.sql` | needs docs | 0 | 2 | 0 | 0 | 2 |
| `261_sprint68_orchestration_intelligence_foundation.sql` | needs docs | 1 | 38 | 0 | 14 | 0 |
| `260_sprint68_ticket_external_credential_activation_binding.sql` | needs docs | 0 | 1 | 0 | 0 | 2 |
| `260_sprint68_platform_development_constitution_policies.sql` | needs docs | 0 | 23 | 2 | 20 | 0 |
| `259_sprint68_ticket_external_secret_intake_surface.sql` | needs docs | 0 | 1 | 1 | 0 | 3 |
| `258_sprint68_ticket_external_delivery_credential_binding.sql` | needs docs | 0 | 3 | 0 | 0 | 3 |
| `257_sprint68_ticket_external_send_execution_adapter.sql` | needs docs | 0 | 2 | 0 | 0 | 2 |
| `257_sprint68_agent_runtime_ledger_readiness.sql` | needs docs | 0 | 5 | 3 | 0 | 0 |
| `256_sprint68_ticket_external_delivery_approval_policy.sql` | needs docs | 0 | 4 | 0 | 0 | 3 |
| `256_sprint68_session_insight_promotion_foundation.sql` | needs docs | 0 | 0 | 1 | 0 | 0 |
| `256_sprint68_dynamic_audit_pipeline_readiness.sql` | needs docs | 0 | 1 | 3 | 0 | 0 |
| `255_sprint68_ticket_notification_delivery_adapters.sql` | needs docs | 0 | 2 | 0 | 0 | 3 |
| `255_sprint68_live_checkout_cleanup_capability_gate.sql` | needs docs | 0 | 0 | 1 | 0 | 0 |
| `254_sprint68_ticket_notification_delivery_cycle.sql` | needs docs | 0 | 2 | 0 | 0 | 3 |
| `254_sprint68_session_insight_scope_link_monitoring.sql` | needs docs | 0 | 0 | 1 | 0 | 0 |
