...
This guide defines how GPT/admin/tenant agents must handle any executable option that is represented as a mode or scope selector. It generalizes the Hostinger `runner_mode` lesson to all mode-bearing surfaces.
