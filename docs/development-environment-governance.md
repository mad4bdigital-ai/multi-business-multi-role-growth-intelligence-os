...
`dev.mad4b.com`, `mcp-dev.mad4b.com`, and `activation-dev.mad4b.com` are reserved for the governed development/staging runtime. They are not customer brand sites and must not receive Production traffic.

`main` is the source branch for the planned local staging hostname family at `dev.mad4b.com`, `mcp-dev.mad4b.com`, and `activation-dev.mad4b.com`. It is not the Hostinger Production deployment branch.
...
|---|---|---|---|---|
| staging | `dev.mad4b.com`, `mcp-dev.mad4b.com`, `activation-dev.mad4b.com` | `main` | Local device through dedicated Dev Cloudflare Tunnel | Planned |
...
- do not configure `dev.mad4b.com`, `mcp-dev.mad4b.com`, or `activation-dev.mad4b.com` as Hostinger Auto Deploy targets;
...
```text
main
  -> planned local staging hostname family (dev.mad4b.com, mcp-dev.mad4b.com, activation-dev.mad4b.com)
...
```text
dev.mad4b.com,mcp-dev.mad4b.com,activation-dev.mad4b.com = planned_local_staging
source_branch = main
