...
The live snapshot contains **9 candidate PRs**, of which **4 are open**, **5 are closed**, **8 are draft**, and **3 report conflicting mergeability**. The snapshot is anchored to current `origin/main` SHA `047c255ded8366ae2c2b39e6a3051c93a21f7a34`; the source snapshot is stored in `spec015-candidate-pr-readonly-evidence-20260812.jsonl`.
