...
- `280_sprint68_session_insight_capability_envelope_approval_gate.sql` — critical_review, score 1203; next: classify route-like strings, then add OpenAPI contract or false-positive exemption
