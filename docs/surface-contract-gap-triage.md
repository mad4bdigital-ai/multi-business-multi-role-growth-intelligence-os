...
- `955_sprint68_external_delivery_admin_control_surface.sql` — critical_review, score 1194; next: classify route-like strings, then add OpenAPI contract or false-positive exemption
