...
- `1036_sprint69_remote_runtime_deploy_dispatch_certification_renewal.sql` — high_review, score 548; next: add targeted patch-index, parity, and governance documentation
