...
- `1036_sprint69_capability_enablement_virtual_admin_tool_bridge.sql` — high_review, score 536; next: add targeted patch-index, parity, and governance documentation
