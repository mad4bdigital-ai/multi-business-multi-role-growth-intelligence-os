...
- `1022_sprint69_repository_close_superseded_positive_smoke_policy.sql` — high_review, score 537; next: add targeted patch-index, parity, and governance documentation
