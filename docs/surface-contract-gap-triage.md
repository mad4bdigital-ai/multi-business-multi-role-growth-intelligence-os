...
- `20260730_repository_reconciliation_lease_control_tool.sql` — critical_review, score 837; next: add targeted patch-index, parity, and governance documentation
...
- `20260723_dynamic_container_override_governance_smoke.sql` — critical_review, score 795; next: add targeted patch-index, parity, and governance documentation
