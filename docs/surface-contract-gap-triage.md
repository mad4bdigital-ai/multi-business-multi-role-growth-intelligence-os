...
- `20260920_wordpress_staging_plugin_deploy_v2_canonical_seed.sql` — critical_review, score 738; next: add targeted patch-index, parity, and governance documentation
