...
- Docs completion: 3.81%
- SQL route OpenAPI coverage: 60.2%
...
- `960_sprint68_remaining_resource_capability_completion_gates.sql` — critical_review, add targeted patch-index, parity, and governance documentation
