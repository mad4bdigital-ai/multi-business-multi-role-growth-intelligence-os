...
| Medium | Raise context attribution at writer boundaries, prioritizing `execution_log` and workspace propagation across the 14 core runtime tables. | Live readback confirms schema and enrichment completion, but historical/new-writer coverage remains sparse and workspace coverage is zero. |
