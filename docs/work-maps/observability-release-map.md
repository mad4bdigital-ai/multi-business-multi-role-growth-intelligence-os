...
flowchart TD
  ...
  n_dynamic_audit_scheduler_runs["dynamic_audit_scheduler_runs<br/>table"]
  ...
  n_growth_intelligence_readiness_assessments["growth_intelligence_readiness_assessments<br/>table"]
