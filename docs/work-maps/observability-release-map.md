...
flowchart TD
  ...
  n_release_gate_events["release_gate_events<br/>table"]
  n_release_operation_evidence["release_operation_evidence<br/>table"]
  n_release_operation_steps["release_operation_steps<br/>table"]
...
- Matching schema objects: **142**
- Diagram objects shown: **45**
- Source migrations: **103**
