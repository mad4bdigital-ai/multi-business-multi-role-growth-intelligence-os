...
flowchart TD
  ...
  n_v_dynamic_audit_pipeline_counts["v_dynamic_audit_pipeline_counts<br/>view"]
  n_v_dynamic_audit_pipeline_quality["v_dynamic_audit_pipeline_quality<br/>view"]
  n_v_dynamic_audit_pipeline_readiness["v_dynamic_audit_pipeline_readiness<br/>view"]
  n_v_external_delivery_recipient_allowlist_readiness["v_external_delivery_recipient_allowlist_readiness<br/>view"]
  n_v_gpt_session_archive_monitoring_summary["v_gpt_session_archive_monitoring_summary<br/>view"]
  ...
  n_v_platform_secret_promotion_monitoring["v_platform_secret_promotion_monitoring<br/>view"]
  n_v_platform_secret_promotion_monitoring_issues["v_platform_secret_promotion_monitoring_issues<br/>view"]
  n_v_platform_secret_promotion_monitoring_summary["v_platform_secret_promotion_monitoring_summary<br/>view"]
...
- Matching schema objects: **158**
- Diagram objects shown: **45**
- Source migrations: **117**
