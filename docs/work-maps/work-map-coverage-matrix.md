...
| Observability & release | 26 | 24 | `data-model-domain-map.md`, `observability-release-map.md`, `workflow-task-orchestration-map.md` | covered |
| Other / uncategorized | 4 | 0 | `data-model-domain-map.md` | taxonomy gap |
