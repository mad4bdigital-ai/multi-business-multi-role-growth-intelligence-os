...
flowchart TD
  ...
  n_version["version<br/>required"]
  n_purpose["purpose<br/>required"]
  n_data_source_state["data_source_state<br/>required"]
  n_multi_business_activity_state["multi_business_activity_state<br/>required"]
  n_tenant_role_access_state["tenant_role_access_state<br/>required"]
  n_service_mode_state["service_mode_state<br/>required"]
  n_human_oversight_state["human_oversight_state<br/>required"]
  n_commercial_entitlement_state["commercial_entitlement_state<br/>required"]
  n_activation_state["activation_state<br/>required"]
  n_auto_bootstrap_state["auto_bootstrap_state<br/>required"]
  n_hard_activation_wrapper_state["hard_activation_wrapper_state<br/>required"]
  n_execution_logging_state["execution_logging_state<br/>required"]
  n_governance_rules["governance_rules<br/>required"]
  n_governance_drift_state["governance_drift_state<br/>required"]
  n_variable_contract_state["variable_contract_state<br/>required"]
  n_http_transport_state["http_transport_state<br/>required"]
  n_logic_pointer_state["logic_pointer_state<br/>required"]
  n_logic_knowledge_state["logic_knowledge_state<br/>required"]
  n_business_type_knowledge_state["business_type_knowledge_state<br/>required"]
  n_logical_search_state["logical_search_state<br/>required"]
  n_anomaly_cluster_state["anomaly_cluster_state<br/>required"]
  n_cluster_auto_repair_state["cluster_auto_repair_state<br/>required"]
  n_output_artifacts_state["output_artifacts_state<br/>required"]
  n_sink_dispatch_state["sink_dispatch_state<br/>required"]
  n_agent_chain_state["agent_chain_state<br/>required"]
  n_local_connector_governance_state["local_connector_governance_state<br/>required"]
  n_agent_chain_events[("agent_chain_events")]
  n_assistance_roles[("assistance_roles")]
  n_business_activity_types[("business_activity_types")]
  n_output_artifacts[("output_artifacts")]
  n_sink_dispatch_log[("sink_dispatch_log")]
  n_task_routes[("task_routes")]
  n_tenants[("tenants")]
  n_multi_business_activity_state --> n_business_activity_types
  n_tenant_role_access_state --> n_tenants
  n_human_oversight_state --> n_assistance_roles
  n_output_artifacts_state --> n_output_artifacts
  n_sink_dispatch_state --> n_sink_dispatch_log
  n_agent_chain_state --> n_agent_chain_events
  n_local_connector_governance_state --> n_task_routes
```
...
- Memory schema states: **26**
- Required memory states: **26**
- Session/memory schema objects: **91**
