...
flowchart TD
  ...
  n_platform_resource_adapters["platform_resource_adapters<br/>table"]
...
- Matching schema objects: **77**
- Diagram objects shown: **45**
- Source migrations: **43**
