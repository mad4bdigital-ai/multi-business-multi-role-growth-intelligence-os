...
> Source hash: `36e562fafeaae9c308707bb91a04b3d710e9a20dacf8d4041052d688e4921122`
> Source count: **36**
> Sources: `http-generic-api/migrations/006_sprint08_planner.sql`, `http-generic-api/migrations/009_sprint05_logic_graph.sql`, `http-generic-api/migrations/016_sprint20_agent_registry.sql`, `http-generic-api/migrations/039_sprint43_data_integrity_and_missing_tables.sql`, `http-generic-api/migrations/040_sprint44_expand_surfaces_and_repair_schema.sql`, `http-generic-api/migrations/041_sprint44b_knowledge_surface_enforcement.sql`, `http-generic-api/migrations/062_sprint56b_connector_registry_diagnostic_views.sql`, `http-generic-api/migrations/066_sprint57_app_tool_bindings.sql`, `http-generic-api/migrations/105_sprint62p_platform_knowledge_graph_runtime.sql`, `http-generic-api/migrations/108_sprint62s_platform_graph_memory_rank_rules.sql`, _... +26 more_
...
flowchart TD
  ...
  c_0["Intent / decision"]
  c_1["Capability source resolution"]
  c_2["Contract surface"]
  c_3["Resource type"]
  c_4["Adapter / recipe"]
  c_5["Graph projection"]
  c_6["Validation / runtime evidence"]
  c_0 --> c_1
  c_1 --> c_2
  c_2 --> c_3
  c_3 --> c_4
  ...
  n_platform_resource_recipes["platform_resource_recipes<br/>table"]
  n_platform_resource_types["platform_resource_types<br/>table"]
  ...
  n_v_platform_resource_capability_baseline["v_platform_resource_capability_baseline<br/>view"]
  n_v_remaining_resource_capability_completion_readiness["v_remaining_resource_capability_completion_readiness<br/>view"]
  n_v_resource_recipe_certification_compact["v_resource_recipe_certification_compact<br/>view"]
  n_v_resource_recipe_registry_compact["v_resource_recipe_registry_compact<br/>view"]
  n_v_session_insight_capability_envelope_actual_request_issues["v_session_insight_capability_envelope_actual_request_issues<br/>view"]
