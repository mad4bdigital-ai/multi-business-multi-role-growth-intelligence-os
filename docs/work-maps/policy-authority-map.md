...
> Source hash: `2a9e0ab573df2c77ab3d17fe7a440651909b3c8e46e9aea543c2361eeadc7269`
> Source count: **101**
...
flowchart TD
  ...
  n_governed_policy_activations["governed_policy_activations<br/>table"]
  ...
  n_governed_policy_sessions["governed_policy_sessions<br/>table"]
  ...
  n_governed_policy_proposals["governed_policy_proposals<br/>table"]
  n_governed_policy_rollbacks["governed_policy_rollbacks<br/>table"]
  n_governed_policy_versions["governed_policy_versions<br/>table"]
  ...
  n_governed_policy_activations --> n_governed_policy_proposals
  n_governed_policy_activations --> n_governed_policy_rollbacks
  n_governed_policy_approvals --> n_governed_policy_proposals
  n_governed_policy_rollbacks --> n_governed_policy_proposals
  n_governed_policy_versions --> n_governed_policy_proposals
  ...
  n_storage_cleanup_operations --> n_storage_targets
  n_storage_cleanup_plans --> n_storage_cleanup_operations
  n_storage_cleanup_plans --> n_storage_targets
  n_storage_execution_leases --> n_storage_cleanup_operations
  n_storage_execution_leases --> n_storage_targets
...
- Matching schema objects: **172**
- Diagram objects shown: **45**
- Source migrations: **101**
