...
> Source hash: `5e484effe66ad5cc69a5c2a6c8fa3cdec152fdb521d7afe29edc958eaae09b22`
> Source count: **743**
...
flowchart LR
  ...
  n_Agents___intelligence["Agents & intelligence<br/>49 tables / 13 views"]
  ...
  n_Connectors___providers["Connectors & providers<br/>39 tables / 9 views"]
  n_Delivery___support["Delivery & support<br/>20 tables / 9 views"]
  n_Developer___API["Developer & API<br/>9 tables / 8 views"]
  n_Governance___authority["Governance & authority<br/>25 tables / 9 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>38 tables / 32 views"]
  n_Other___uncategorized["Other / uncategorized<br/>52 tables / 11 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>69 tables / 48 views"]
  n_Repository___development["Repository & development<br/>25 tables / 7 views"]
  n_Sessions___memory["Sessions & memory<br/>25 tables / 34 views"]
  n_Tenancy___identity["Tenancy & identity<br/>45 tables / 8 views"]
  n_Workflow___tasks["Workflow & tasks<br/>28 tables / 4 views"]
```
...
| Agents & intelligence | 49 | 13 | `agent_chain_events`, `agent_delegations`, `agent_handoff_state_access_log`, `agent_handoff_state_registry`, `agent_logic_pack_bindings`, `agent_model_runs`, `agent_response_profile_registry`, `agent_skill_grant_requests`, `agent_skill_grants`, `agent_skills`, ... |
...
| Governance & authority | 25 | 9 | `admin_scope_grants`, `auth_email_delivery_attempts`, `auth_password_reset_tokens`, `authority_scope_registry`, `authority_scope_shadow_evidence`, `budget_quota_authority_registry`, `compliance_profiles`, `container_authority_epochs`, `container_authority_idempotency`, `container_override_policy_registry`, ... |
...
| Observability & release | 38 | 32 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `growth_control_activity_binding_readiness_evidence`, `growth_control_config_resolution_snapshots`, `growth_control_shadow_parity_evidence`, `incidents`, ... |
| Other / uncategorized | 52 | 11 | `canonical_identifier_column_binding_registry`, `canonical_identifier_contract_registry`, `connection_ownership_scopes`, `container_cache_invalidation_events`, `container_canary_observations`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, ... |
| Platform resources & graph | 69 | 48 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `canonical_capabilities`, `capability_aliases`, `capability_apply_authorization_policy_registry`, `capability_enablement_requests`, `capability_enablement_steps`, `capability_envelope_template_resolutions`, `capability_envelope_templates`, ... |
| Repository & development | 25 | 7 | `dev_agent_proposals`, `external_delivery_provider_adapter_enablement_proposals`, `operation_managed_git_worker_leases`, `platform_private_repo_mirrors`, `proposal_discussions`, `repo_capability_candidates`, `repo_certification_runs`, `repo_conflict_path_policies`, `repo_conflict_resolution_plans`, `repo_file_audit_findings`, ... |
...
| Tenancy & identity | 45 | 8 | `actor_profiles`, `assistance_roles`, `container_role_assignments`, `container_role_template_permissions`, `container_role_template_registry`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, ... |
| Workflow & tasks | 28 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `container_override_approvals`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, ... |
...
| `approval_holds` | table | Workflow & tasks | 3 | 15 | `step_runs`, `tenants` |
...
| `auth_email_delivery_attempts` | table | Governance & authority | 1 | 19 | - |
| `auth_email_outbox` | table | Delivery & support | 1 | 14 | - |
| `auth_email_outbox_delivery_attempts` | table | Delivery & support | 1 | 20 | `auth_email_outbox` |
| `auth_password_reset_tokens` | table | Governance & authority | 1 | 11 | `users` |
| `authority_scope_registry` | table | Governance & authority | 1 | 10 | `tenants` |
| `authority_scope_shadow_evidence` | table | Governance & authority | 1 | 23 | `tenants` |
...
| `canonical_identifier_column_binding_registry` | table | Other / uncategorized | 1 | - | `canonical_identifier_contract_registry` |
| `canonical_identifier_contract_registry` | table | Other / uncategorized | 1 | - | - |
...
| `connection_ownership_scopes` | table | Other / uncategorized | 1 | 19 | `tenants` |
| `connector_family_registry` | table | Connectors & providers | 1 | 14 | - |
| `contacts` | table | Brand & business | 1 | 11 | `customers`, `tenants` |
| `container_authority_epochs` | table | Governance & authority | 1 | 5 | `tenants` |
| `container_authority_idempotency` | table | Governance & authority | 1 | 8 | - |
| `container_cache_invalidation_events` | table | Other / uncategorized | 1 | 8 | `tenants` |
| `container_canary_observations` | table | Other / uncategorized | 1 | 16 | - |
| `container_classification_type_registry` | table | Other / uncategorized | 1 | 15 | - |
| `container_classifications` | table | Other / uncategorized | 1 | 17 | `containers`, `tenants` |
| `container_closure` | table | Other / uncategorized | 1 | 9 | `tenants` |
| `container_effective_context_ledger` | table | Other / uncategorized | 1 | 29 | `tenants` |
| `container_identity_projection_issues` | table | Other / uncategorized | 1 | 13 | `tenants` |
| `container_override_approvals` | table | Workflow & tasks | 1 | 8 | - |
| `container_override_consumptions` | table | Other / uncategorized | 1 | 13 | - |
| `container_override_policy_registry` | table | Governance & authority | 1 | 9 | - |
| `container_override_requests` | table | Other / uncategorized | 1 | 27 | `tenants` |
| `container_projection_runs` | table | Other / uncategorized | 1 | 12 | - |
| `container_relationship_type_registry` | table | Other / uncategorized | 1 | 14 | - |
| `container_relationships` | table | Other / uncategorized | 1 | 16 | `tenants` |
| `container_resolution_performance_samples` | table | Other / uncategorized | 1 | 12 | `tenants` |
| `container_resource_bindings` | table | Other / uncategorized | 1 | 28 | `containers`, `tenants` |
| `container_resource_dimension_registry` | table | Other / uncategorized | 1 | 17 | - |
| `container_role_assignments` | table | Tenancy & identity | 1 | 17 | `containers`, `tenants` |
| `container_role_template_permissions` | table | Tenancy & identity | 1 | 10 | - |
| `container_role_template_registry` | table | Tenancy & identity | 1 | 12 | - |
| `container_rollout_policy_registry` | table | Governance & authority | 1 | 13 | - |
| `container_shadow_canary_registry` | table | Other / uncategorized | 1 | 10 | `tenants` |
| `container_shadow_comparisons` | table | Other / uncategorized | 1 | 13 | `tenants` |
| `container_type_registry` | table | Other / uncategorized | 1 | 14 | - |
| `containers` | table | Other / uncategorized | 1 | 14 | `tenants` |
...
| `execution_plan_mutation_receipts` | table | Tenancy & identity | 1 | - | - |
...
| `governed_tool_response_chunks` | table | Developer & API | 4 | - | - |
...
| `growth_control_activity_binding_readiness_evidence` | table | Observability & release | 1 | - | `growth_control_brand_activity_bindings` |
| `growth_control_activity_pack_definitions` | table | Other / uncategorized | 1 | 10 | - |
| `growth_control_activity_pack_versions` | table | Other / uncategorized | 1 | 13 | - |
| `growth_control_brand_activity_bindings` | table | Brand & business | 1 | 22 | `tenants` |
| `growth_control_compiled_plan_snapshots` | table | Tenancy & identity | 1 | 26 | `growth_control_brand_activity_bindings`, `growth_control_compiled_policy_snapshots`, `growth_control_config_resolution_snapshots`, `tenants` |
| `growth_control_compiled_policy_snapshots` | table | Governance & authority | 1 | 19 | `growth_control_brand_activity_bindings`, `tenants` |
| `growth_control_config_definitions` | table | Other / uncategorized | 1 | 14 | - |
| `growth_control_config_resolution_snapshots` | table | Observability & release | 1 | 19 | `plans`, `tenants` |
| `growth_control_config_versions` | table | Other / uncategorized | 1 | 29 | `plans`, `tenants` |
| `growth_control_invalidation_revisions` | table | Other / uncategorized | 1 | 16 | `tenants` |
| `growth_control_shadow_parity_evidence` | table | Observability & release | 1 | - | - |
| `growth_control_shadow_parity_mappings` | table | Other / uncategorized | 1 | - | - |
| `growth_dashboard_instruction_registry` | table | Other / uncategorized | 1 | - | - |
| `growth_dashboard_metric_registry` | table | Other / uncategorized | 1 | - | - |
| `growth_dashboard_tab_profile_registry` | table | Other / uncategorized | 1 | - | - |
...
| `operation_managed_git_worker_leases` | table | Repository & development | 2 | - | `repository_automation_runs` |
| `operation_run_ownership` | table | Other / uncategorized | 1 | - | `repository_automation_runs` |
| `operational_alert_ci_signal_events` | table | Other / uncategorized | 1 | - | `operational_alerts` |
...
| `operational_alert_sync_runs` | table | Other / uncategorized | 1 | - | - |
| `operational_alerts` | table | Other / uncategorized | 2 | - | - |
...
| `platform_data_table_registry` | table | Other / uncategorized | 1 | 27 | - |
| `platform_endpoint_aliases` | table | Developer & API | 1 | 11 | - |
...
| `platform_evidence_events` | table | Observability & release | 1 | 22 | - |
...
| `platform_outbox_consumers` | table | Other / uncategorized | 1 | - | - |
| `platform_outbox_deliveries` | table | Other / uncategorized | 1 | - | - |
| `platform_outbox_event_types` | table | Other / uncategorized | 1 | - | - |
| `platform_outbox_events` | table | Other / uncategorized | 1 | - | - |
| `platform_outbox_mask_policies` | table | Other / uncategorized | 1 | - | - |
...
| `platform_secret_movement_ledger` | table | Other / uncategorized | 1 | 15 | - |
...
| `release_advisor_recommendations` | table | Observability & release | 1 | - | - |
| `release_advisor_runs` | table | Observability & release | 1 | - | - |
| `release_async_deployments` | table | Observability & release | 1 | - | - |
| `release_gate_adapters` | table | Observability & release | 1 | - | - |
| `release_gate_events` | table | Observability & release | 1 | - | - |
| `release_gates` | table | Observability & release | 1 | - | - |
| `release_operation_evidence` | table | Observability & release | 1 | - | - |
| `release_operation_steps` | table | Workflow & tasks | 1 | - | - |
| `release_operations` | table | Observability & release | 1 | - | - |
...
| `repo_conflict_path_policies` | table | Repository & development | 1 | - | - |
| `repo_conflict_resolution_plans` | table | Repository & development | 1 | - | - |
...
| `repository_advisory_comment_plans` | table | Tenancy & identity | 2 | - | - |
| `repository_authority_aliases` | table | Governance & authority | 1 | - | - |
| `repository_authority_bindings` | table | Governance & authority | 1 | - | - |
| `repository_automation_receipts` | table | Other / uncategorized | 1 | 15 | - |
| `repository_automation_runs` | table | Other / uncategorized | 1 | 24 | - |
| `repository_automation_step_runs` | table | Workflow & tasks | 1 | 18 | `step_runs` |
...
| `repository_main_moved_trigger_events` | table | Other / uncategorized | 2 | - | - |
| `repository_mutation_plans_v6` | table | Tenancy & identity | 1 | 15 | `approval_holds`, `plans`, `tenants`, `users` |
| `repository_mutation_runs_v6` | table | Other / uncategorized | 2 | 26 | `approval_holds`, `plans`, `tenants`, `users` |
| `repository_operation_leases` | table | Other / uncategorized | 2 | 25 | - |
...
| `secret_references` | table | Governance & authority | 3 | 11 | `tenants` |
...
| `sql_cache_runtime_policies` | table | Other / uncategorized | 1 | 7 | - |
...
| `tenant_brand_links` | table | Tenancy & identity | 1 | 8 | `tenants` |
| `tenant_capability_shadow_decisions` | table | Platform resources & graph | 1 | 13 | `tenants`, `users` |
| `tenant_dynamic_dashboard_preferences` | table | Tenancy & identity | 1 | - | - |
| `tenant_gpt_oauth_authorization_codes` | table | Tenancy & identity | 1 | 10 | `tenants`, `users` |
| `tenant_growth_recommendation_events` | table | Tenancy & identity | 1 | - | - |
| `tenant_integration_policies` | table | Tenancy & identity | 1 | 13 | `tenants` |
| `tenant_package_installs` | table | Assets & packages | 1 | - | - |
| `tenant_platform_endpoint_tools` | table | Tenancy & identity | 3 | - | - |
| `tenant_relationships` | table | Tenancy & identity | 1 | 6 | - |
| `tenant_resolution_case_events` | table | Tenancy & identity | 1 | 12 | `tenant_resolution_cases` |
| `tenant_resolution_cases` | table | Tenancy & identity | 1 | 27 | `approval_holds`, `tenants` |
| `tenant_resolution_playbooks` | table | Tenancy & identity | 1 | 19 | - |
| `tenant_resolution_readbacks` | table | Tenancy & identity | 1 | 11 | `tenant_resolution_cases` |
...
| `workspace_registry` | table | Tenancy & identity | 3 | 12 | `tenants` |
| `workspace_resource_grants` | table | Tenancy & identity | 3 | - | - |
...
| `v_approval_hold_identity_collation_readiness` | view | Workflow & tasks | 1 | - | - |
| `v_approval_hold_parent_resolution` | view | Workflow & tasks | 1 | - | - |
| `v_authority_scope_shadow_summary` | view | Governance & authority | 1 | - | - |
...
| `v_container_active_hierarchy` | view | Other / uncategorized | 1 | - | - |
| `v_container_audit_coverage` | view | Observability & release | 1 | - | - |
| `v_container_authority_foundation_summary` | view | Governance & authority | 1 | - | - |
| `v_container_canary_monitoring_summary` | view | Observability & release | 1 | - | - |
| `v_container_latest_shadow_audit_coverage` | view | Observability & release | 1 | - | - |
| `v_container_latest_shadow_performance_summary` | view | Other / uncategorized | 1 | - | - |
| `v_container_latest_shadow_run_summary` | view | Other / uncategorized | 1 | - | - |
| `v_container_override_readiness` | view | Observability & release | 1 | - | - |
| `v_container_relationship_issues` | view | Other / uncategorized | 1 | - | - |
| `v_container_resolution_performance_summary` | view | Other / uncategorized | 1 | - | - |
| `v_container_rollout_readiness` | view | Observability & release | 2 | - | - |
| `v_container_rollout_readiness_v2` | view | Observability & release | 1 | - | - |
| `v_container_shadow_mismatch_summary` | view | Other / uncategorized | 1 | - | - |
| `v_context_kernel_connection_ownership_compatibility` | view | Other / uncategorized | 1 | - | - |
...
| `v_governed_response_chunk_ownership_readiness` | view | Observability & release | 1 | - | - |
| `v_governed_response_chunk_schema_readiness` | view | Observability & release | 1 | - | - |
...
| `v_gpt_session_archive_monitoring_summary` | view | Sessions & memory | 2 | - | - |
| `v_growth_control_shadow_parity_summary` | view | Other / uncategorized | 1 | - | - |
...
| `v_operational_alerts_open` | view | Other / uncategorized | 1 | - | - |
...
| `v_platform_endpoint_canonical_identity` | view | Developer & API | 1 | - | - |
| `v_platform_endpoint_export_schema_parity` | view | Developer & API | 1 | - | - |
...
| `v_platform_governed_bindings_current` | view | Other / uncategorized | 1 | - | - |
| `v_platform_governed_capabilities_current` | view | Platform resources & graph | 1 | - | - |
| `v_platform_governed_exports_current` | view | Other / uncategorized | 1 | - | - |
...
| `v_platform_secret_promotion_monitoring` | view | Observability & release | 2 | - | - |
| `v_platform_secret_promotion_monitoring_issues` | view | Observability & release | 2 | - | - |
| `v_platform_secret_promotion_monitoring_summary` | view | Observability & release | 2 | - | - |
| `v_platform_tool_dispatch_integrity` | view | Developer & API | 2 | - | - |
| `v_platform_virtual_tool_bindings_classified` | view | Developer & API | 2 | - | - |
| `v_platform_virtual_tool_bindings_current` | view | Developer & API | 1 | - | - |
...
| `v_platform_virtual_tool_exports_current` | view | Developer & API | 2 | - | - |
| `v_platform_virtual_tool_identity_resolution` | view | Developer & API | 1 | - | - |
...
| `v_repository_authority_binding_readiness` | view | Governance & authority | 1 | - | - |
| `v_repository_capability_binding_readiness` | view | Platform resources & graph | 1 | - | - |
| `v_repository_mutation_descriptor_policy_readiness` | view | Governance & authority | 1 | - | - |
