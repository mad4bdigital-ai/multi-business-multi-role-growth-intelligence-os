...
> Source hash: `3e1c9ad01fb04b2a4a447c9d8759ebe08dd62c206307402f0bf0358910292d9a`
> Source count: **650**
...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>33 tables / 30 views"]
  n_Other___uncategorized["Other / uncategorized<br/>38 tables / 7 views"]
...
| Observability & release | 33 | 30 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 38 | 7 | `container_cache_invalidation_events`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, `container_relationship_type_registry`, ... |
