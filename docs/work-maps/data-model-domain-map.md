...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>20 tables / 6 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>41 tables / 26 views"]
...
| Observability & release | 41 | 26 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `operational_alert_ci_signal_events`, `operational_alert_lifecycle_events`, ... |
