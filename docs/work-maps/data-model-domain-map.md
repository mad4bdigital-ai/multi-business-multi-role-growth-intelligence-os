...
> Source hash: `252f64091d918e9e98d9b5e6af29a7d24224c09970fa09b841a8eb08fdd37def`
> Source count: **568**
...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>19 tables / 7 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>13 tables / 13 views"]
  n_Observability___release["Observability & release<br/>27 tables / 28 views"]
...
| Governance & authority | 19 | 7 | `admin_scope_grants`, `auth_password_reset_tokens`, `budget_quota_authority_registry`, `compliance_profiles`, `container_authority_epochs`, `container_authority_idempotency`, `container_override_policy_registry`, `container_rollout_policy_registry`, `database_collation_policy_exception_registry`, `database_collation_policy_registry`, ... |
...
| Observability & release | 27 | 28 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
