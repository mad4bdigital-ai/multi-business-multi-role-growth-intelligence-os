...
> Source hash: `3e7b1b3106917bf9751e10c6de82b86c24b69895c430940be1bd0836d327957c`
> Source count: **526**
...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>27 tables / 23 views"]
  n_Other___uncategorized["Other / uncategorized<br/>2 tables / 0 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>29 tables / 7 views"]
...
| Observability & release | 27 | 23 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 2 | 0 | `platform_secret_movement_ledger`, `repository_mutation_runs_v6` |
...
| Tenancy & identity | 29 | 7 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `invitations`, `local_connector_user_configs`, `memberships`, `plans`, ... |
