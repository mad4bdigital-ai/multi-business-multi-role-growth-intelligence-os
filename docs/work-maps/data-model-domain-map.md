...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>51 tables / 32 views"]
...
| `governed_tool_response_chunks` | table | Developer & API | generated_domain_rule | - | 5 | - | - |
