...
> Source hash: `ec016e80c32f066517fbabb488acef35294f684296941506a61db42b612e59c8`
> Source count: **572**
...
flowchart LR
  ...
  n_Platform_resources___graph["Platform resources & graph<br/>56 tables / 39 views"]
...
| Platform resources & graph | 56 | 39 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `capability_apply_authorization_policy_registry`, `capability_resolution_envelope_ledger`, `decision_runs`, `external_delivery_provider_adapter_readiness_decisions`, `intent_resolutions`, `local_connector_capability_grants`, `platform_capability_certifications`, ... |
...
| `endpoints` | table | Developer & API | 2 | - | - |
...
| `openapi_endpoint_inventory_sync_runs` | table | Developer & API | 2 | - | - |
