...
> Source hash: `a48bc1ee634cdc17e47a1eb426cd7c0905ea0418b71efa8943edb2558229769d`
> Source count: **653**
...
flowchart LR
  ...
  n_Other___uncategorized["Other / uncategorized<br/>41 tables / 7 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>61 tables / 44 views"]
...
| Other / uncategorized | 41 | 7 | `container_cache_invalidation_events`, `container_canary_observations`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, ... |
| Platform resources & graph | 61 | 44 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `canonical_capabilities`, `capability_aliases`, `capability_apply_authorization_policy_registry`, `capability_enablement_requests`, `capability_enablement_steps`, `capability_resolution_envelope_ledger`, `decision_runs`, ... |
