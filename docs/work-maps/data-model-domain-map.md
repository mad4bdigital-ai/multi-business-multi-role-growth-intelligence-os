...
> Source hash: `1a0b9261afdfacfb255424b99801bbf63db9b702e2c9309e1d215cced9d10131`
> Source count: **620**
...
flowchart LR
  ...
  n_Workflow___tasks["Workflow & tasks<br/>26 tables / 4 views"]
```
...
| Workflow & tasks | 26 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `container_override_approvals`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, ... |
