...
> Source hash: `7e9abfb5412643c847757cf520576f5be030382903431ca108649614b4e80c1a`
> Source count: **588**
...
flowchart LR
  ...
  n_Workflow___tasks["Workflow & tasks<br/>25 tables / 4 views"]
```
...
| Workflow & tasks | 25 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `container_override_approvals`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, ... |
