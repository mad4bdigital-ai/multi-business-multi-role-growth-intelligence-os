...
> Source hash: `c25db95f1872c6405065808b88b182e0e53b280c90a6aaef9775b075d002c84a`
> Source count: **737**
...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>24 tables / 9 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>35 tables / 31 views"]
  n_Other___uncategorized["Other / uncategorized<br/>46 tables / 10 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>44 tables / 8 views"]
...
| Observability & release | 35 | 31 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 46 | 10 | `canonical_identifier_column_binding_registry`, `canonical_identifier_contract_registry`, `connection_ownership_scopes`, `container_cache_invalidation_events`, `container_canary_observations`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, ... |
...
| Tenancy & identity | 44 | 8 | `actor_profiles`, `assistance_roles`, `container_role_assignments`, `container_role_template_permissions`, `container_role_template_registry`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, ... |
