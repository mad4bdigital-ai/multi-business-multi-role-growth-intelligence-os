...
> Source hash: `c70b2f7694103b03e33c3e532cc8f84b46cac2b6f77f50a7733d9890d4b638f4`
> Source count: **842**
...
flowchart LR
  ...
  n_Workflow___tasks["Workflow & tasks<br/>43 tables / 4 views"]
```
...
| Workflow & tasks | 43 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `governed_policy_approvals`, `growth_control_activity_pack_definitions`, ... |
