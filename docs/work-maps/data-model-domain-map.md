Warning: truncated output (original token count: 30489)
Total output lines: 879
...
| `platform_plugin_smoke_certifications` | table | Agents & intelligence | generated_domain_rule | - …489 tokens truncated…in_rule | - | 1 | - | - |
