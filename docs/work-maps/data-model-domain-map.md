...
flowchart LR
  ...
  n_Developer___API["Developer & API<br/>10 tables / 9 views"]
...
| Developer & API | 10 | 9 | `admin_platform_endpoint_tools`, `developer_apps`, `endpoints`, `governed_tool_response_chunks`, `offsite_drive_upload_records`, `openapi_endpoint_inventory_sync_runs`, `platform_endpoint_aliases`, `platform_tool_dispatch_bindings`, `platform_tool_scope_bindings`, `uploads`, ... |
...
| `platform_plugin_capabilities` | table | Platform resources & graph | generated_domain_rule | - | 2 | 21 | - |
| `platform_plugin_capability_exports` | table | Platform resources & graph | generated_domain_rule | - | 2 | 12 | - |
...
| `platform_tool_dispatch_bindings` | table | Developer & API | generated_domain_rule | - | 2 | - | - |
