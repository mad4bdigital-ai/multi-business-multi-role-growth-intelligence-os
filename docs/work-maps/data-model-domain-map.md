...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>25 tables / 6 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>44 tables / 27 views"]
  n_Other___unresolved["Other / unresolved<br/>1 tables / 0 views"]
...
| Observability & release | 44 | 27 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `growth_control_activity_binding_readiness_evidence`, `growth_control_shadow_parity_evidence`, `growth_control_shadow_parity_mappings`, `incidents`, ... |
| Other / unresolved | 1 | 0 | `growth_control_invalidation_revisions` |
...
| `growth_control_invalidation_revisions` | table | Other / unresolved | unmatched | - | 1 | 16 | `tenants` |
