...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>53 tables / 33 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>99 tables / 63 views"]
  n_Repository___development["Repository & development<br/>37 tables / 12 views"]
...
| Observability & release | 53 | 33 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `growth_control_activity_binding_readiness_evidence`, `growth_control_decision_evidence`, `growth_control_normalized_metric_observations`, `growth_control_observability_samples`, ... |
...
| Repository & development | 37 | 12 | `dev_agent_proposals`, `external_delivery_provider_adapter_enablement_proposals`, `governed_policy_proposals`, `platform_private_repo_mirrors`, `proposal_discussions`, `repo_capability_candidates`, `repo_certification_runs`, `repo_conflict_path_policies`, `repo_conflict_resolution_plans`, `repo_file_audit_findings`, ... |
...
| `runtime_break_glass_incidents` | table | Observability & release | generated_domain_rule | - | 1 | - | - |
