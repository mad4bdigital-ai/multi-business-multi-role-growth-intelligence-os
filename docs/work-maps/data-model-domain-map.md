...
flowchart LR
  ...
  n_Brand___business["Brand & business<br/>6 tables / 0 views"]
  ...
  n_Governance___authority["Governance & authority<br/>21 tables / 6 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>44 tables / 26 views"]
  n_Other___unresolved["Other / unresolved<br/>5 tables / 1 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>40 tables / 8 views"]
  n_Workflow___tasks["Workflow & tasks<br/>29 tables / 4 views"]
```
...
| Brand & business | 6 | 0 | `brand_site_bindings`, `brand_skill_policies`, `contacts`, `customer_sessions`, `customers`, `growth_control_brand_activity_bindings` |
...
| Observability & release | 44 | 26 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `growth_control_activity_binding_readiness_evidence`, `growth_control_config_resolution_snapshots`, `growth_control_shadow_parity_evidence`, `incidents`, ... |
| Other / unresolved | 5 | 1 | `growth_control_activity_pack_definitions`, `growth_control_activity_pack_versions`, `growth_control_config_definitions`, `growth_control_config_versions`, `growth_control_shadow_parity_mappings`, `v_growth_control_shadow_parity_summary` |
...
| Tenancy & identity | 40 | 8 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `growth_control_compiled_plan_snapshots`, `invitations`, `local_connector_user_configs`, ... |
| Workflow & tasks | 29 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, `local_connector_device_routes`, ... |
...
| `growth_control_activity_pack_definitions` | table | Other / unresolved | unmatched | - | 1 | 10 | - |
| `growth_control_activity_pack_versions` | table | Other / unresolved | unmatched | - | 1 | 13 | - |
| `growth_control_brand_activity_bindings` | table | Brand & business | generated_domain_rule | - | 1 | 22 | `tenants` |
...
| `growth_control_config_definitions` | table | Other / unresolved | unmatched | - | 1 | 14 | - |
| `growth_control_config_resolution_snapshots` | table | Observability & release | generated_domain_rule | - | 1 | 19 | `plans`, `tenants` |
| `growth_control_config_versions` | table | Other / unresolved | unmatched | - | 1 | 29 | `plans`, `tenants` |
| `growth_control_shadow_parity_evidence` | table | Observability & release | generated_domain_rule | - | 1 | - | - |
| `growth_control_shadow_parity_mappings` | table | Other / unresolved | unmatched | - | 1 | - | - |
...
| `v_growth_control_shadow_parity_summary` | view | Other / unresolved | unmatched | - | 1 | - | - |
