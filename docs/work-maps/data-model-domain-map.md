...
> Source hash: `bc5f6749d420548f1f85cdef06f59a7558bb3c05bcd0f8ae07785300ff273eb9`
> Source count: **520**
...
flowchart LR
  ...
  n_Other___uncategorized["Other / uncategorized<br/>1 tables / 0 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>44 tables / 32 views"]
...
| Observability & release | 26 | 23 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, `platform_backup_policies`, ... |
| Other / uncategorized | 1 | 0 | `platform_secret_movement_ledger` |
| Platform resources & graph | 44 | 32 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `capability_apply_authorization_policy_registry`, `capability_resolution_envelope_ledger`, `decision_runs`, `external_delivery_provider_adapter_readiness_decisions`, `intent_resolutions`, `local_connector_capability_grants`, `platform_capability_certifications`, ... |
