...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>45 tables / 6 views"]
...
| `platform_runtime_config` | table | Platform resources & graph | generated_domain_rule | - | 2 | 6 | - |
