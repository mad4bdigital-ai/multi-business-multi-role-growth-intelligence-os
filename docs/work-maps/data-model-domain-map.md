...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>32 tables / 29 views"]
  n_Other___uncategorized["Other / uncategorized<br/>39 tables / 5 views"]
...
| Observability & release | 32 | 29 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 39 | 5 | `container_cache_invalidation_events`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, `container_relationship_type_registry`, ... |
