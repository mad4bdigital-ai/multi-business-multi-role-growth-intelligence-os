...
| `act_as_user_sessions` | table | Tenancy & identity | generated_domain_rule | - | 3 | 26 | `tenants` |
...
| `growth_control_config_versions` | table | Governance & authority | registry:growth_control_configuration_objects | `data-model-domain-map`, `observability-release-map`, `platform-resource-graph-map`, `policy-authority-map` | 3 | 30 | `plans`, `tenants` |
...
| `local_connector_device_routes` | table | Workflow & tasks | generated_domain_rule | - | 3 | 26 | `tenants`, `users` |
...
| `storage_execution_leases` | table | Governance & authority | registry:spec014_hostinger_storage_execution_leases | `data-model-domain-map`, `execution-log-evidence-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 2 | - | `storage_cleanup_operations`, `storage_targets` |
...
| `tenant_brand_links` | table | Tenancy & identity | generated_domain_rule | - | 2 | 8 | `tenants` |
...
| `tenant_gpt_sso_sessions` | table | Tenancy & identity | generated_domain_rule | - | 1 | 11 | `tenants`, `users` |
...
| `user_credentials` | table | Tenancy & identity | generated_domain_rule | - | 1 | 6 | `users` |
