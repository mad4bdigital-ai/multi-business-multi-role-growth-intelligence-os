...
| `admin_platform_endpoint_tools` | table | Developer & API | generated_domain_rule | - | 10 | 16 | - |
...
| `local_gateway_tools` | table | Connectors & providers | generated_domain_rule | - | 4 | 26 | - |
