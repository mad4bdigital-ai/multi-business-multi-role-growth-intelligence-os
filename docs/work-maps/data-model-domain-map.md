...
> Source hash: `763f2907274cf6d6d8ecb20caa8124a20f4804498a6ebea8a71c068828bfa2ca`
> Source count: **846**
...
| `execution_policies` | table | Governance & authority | registry:execution_policy_registry | `data-model-domain-map`, `observability-release-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 2 | - | - |
