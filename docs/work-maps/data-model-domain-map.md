...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>40 tables / 6 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>49 tables / 31 views"]
  n_Other___unresolved["Other / unresolved<br/>4 tables / 1 views"]
  ...
  n_Workflow___tasks["Workflow & tasks<br/>40 tables / 4 views"]
```
...
| Workflow & tasks | 40 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `governed_policy_approvals`, `growth_control_activity_pack_definitions`, ... |
...
| `managed_execution_bindings` | table | Other / unresolved | unmatched | - | 1 | - | - |
| `managed_execution_events` | table | Other / unresolved | unmatched | - | 1 | - | - |
...
| `storage_authorized_injection_rollbacks` | table | Other / unresolved | unmatched | - | 1 | - | `storage_authorized_injection_states` |
| `storage_authorized_injection_states` | table | Other / unresolved | unmatched | - | 1 | - | - |
...
| `v_storage_cleanup_operation_readback` | view | Other / unresolved | unmatched | - | 1 | - | - |
