...
> Source hash: `280d985249412d6635b85b5da01da310f868d9686be68281adeda92bd67864fa`
> Source count: **547**
...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>27 tables / 25 views"]
  n_Other___uncategorized["Other / uncategorized<br/>9 tables / 1 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>33 tables / 7 views"]
  n_Workflow___tasks["Workflow & tasks<br/>24 tables / 4 views"]
```
...
| Observability & release | 27 | 25 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 9 | 1 | `growth_dashboard_instruction_registry`, `growth_dashboard_metric_registry`, `growth_dashboard_tab_profile_registry`, `operational_alert_notification_outbox`, `operational_alert_rule_registry`, `operational_alert_sync_runs`, `operational_alerts`, `platform_secret_movement_ledger`, `repository_mutation_runs_v6`, `v_operational_alerts_open` |
...
| Tenancy & identity | 33 | 7 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `invitations`, `local_connector_user_configs`, `memberships`, `plans`, ... |
| Workflow & tasks | 24 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, `local_connector_device_routes`, ... |
...
| `agent_surface_catalog` | table | Agents & intelligence | 2 | - | - |
...
| `tenant_agent_surface_deployments` | table | Tenancy & identity | 2 | - | `agent_surface_catalog` |
...
| `user_agent_surface_preferences` | table | Tenancy & identity | 2 | - | `agent_surface_catalog` |
