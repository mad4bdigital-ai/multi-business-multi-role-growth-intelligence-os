...
flowchart LR
  ...
  n_Tenancy___identity["Tenancy & identity<br/>39 tables / 10 views"]
...
| Tenancy & identity | 39 | 10 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `invitations`, `local_connector_user_configs`, `memberships`, ... |
...
| `tenant_resolution_cases` | table | Tenancy & identity | generated_domain_rule | - | 2 | 27 | `approval_holds`, `tenants` |
