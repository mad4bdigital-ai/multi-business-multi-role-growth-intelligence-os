...
> Source hash: `8f19a23247ba52e7c09961baa7e1f6c1b0d0d6cf65bc49f6fee5d3b669bf66bf`
> Source count: **843**
...
| `local_manager_desktop_commands` | table | Workflow & tasks | registry:local_manager_desktop_command_queue | `connector-provider-map`, `data-model-domain-map`, `execution-log-evidence-map`, `workflow-task-orchestration-map` | 1 | 20 | `tenants`, `users` |
