...
> Source hash: `ea61243f9b9d50312d24825f4eed7dd9f9ffbc779352de9336e8cf68789a4405`
> Source count: **643**
...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>33 tables / 29 views"]
  n_Other___uncategorized["Other / uncategorized<br/>38 tables / 5 views"]
...
| Observability & release | 33 | 29 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
| Other / uncategorized | 38 | 5 | `container_cache_invalidation_events`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, `container_relationship_type_registry`, ... |
...
| `v_container_rollout_readiness` | view | Observability & release | 1 | - | - |
