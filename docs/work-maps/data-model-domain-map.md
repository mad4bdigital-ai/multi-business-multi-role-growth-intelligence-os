...
```mermaid
flowchart LR
  n_Activation___onboarding["Activation & onboarding<br/>23 tables / 24 views"]
  n_Agents___intelligence["Agents & intelligence<br/>37 tables / 8 views"]
  ...
  n_Assets___packages -->|4| n_Tenancy___identity
  n_Brand___business -->|4| n_Tenancy___identity
  n_Commercial___usage -->|11| n_Tenancy___identity
  n_Connectors___providers -->|27| n_Tenancy___identity
  n_Delivery___support -->|2| n_Agents___intelligence
  n_Delivery___support -->|3| n_Brand___business
  n_Delivery___support -->|1| n_Platform_resources___graph
  n_Delivery___support -->|2| n_Repository___development
  n_Delivery___support -->|14| n_Tenancy___identity
  ...
  n_Platform_resources___graph -->|3| n_Tenancy___identity
  n_Platform_resources___graph -->|2| n_Workflow___tasks
  n_Repository___development -->|1| n_Delivery___support
  n_Repository___development -->|3| n_Tenancy___identity
...
|---|---:|---:|---|
| Activation & onboarding | 23 | 24 | `activation_attention_rule_registry`, `activation_auth_source_router`, `activation_authorized_surface_registry`, `activation_callback_registry`, `activation_connector_pack_component_registry`, `activation_connector_pack_registry`, `activation_container_relationship_type_registry`, `activation_container_relationships`, `activation_dynamic_tab_discovery_rule_registry`, `activation_dynamic_tab_registry`, `activation_dynamic_tab_section_registry`, `activation_freshness_ledger`, ... |
| Agents & intelligence | 37 | 8 | `agent_chain_events`, `agent_delegations`, `agent_logic_pack_bindings`, `agent_model_runs`, `agent_skill_grants`, `agent_skills`, `agent_supervision_policy`, `agent_tool_bindings`, `agent_tool_calls`, `agent_tool_index`, `agent_workflow_bindings`, `agents`, ... |
