...
> Source hash: `7b5aa1ebe11e0388f030192335c71636f89e08e94179f7e7a0b0ef8475bc56f9`
> Source count: **663**
...
flowchart LR
  ...
  n_Developer___API["Developer & API<br/>9 tables / 4 views"]
  ...
  n_Other___uncategorized["Other / uncategorized<br/>40 tables / 7 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>63 tables / 44 views"]
...
| Developer & API | 9 | 4 | `admin_platform_endpoint_tools`, `developer_apps`, `endpoints`, `governed_tool_response_chunks`, `offsite_drive_upload_records`, `openapi_endpoint_inventory_sync_runs`, `platform_endpoint_aliases`, `platform_tool_dispatch_bindings`, `uploads`, `v_gpt_schema_db_coverage_issues`, ... |
...
| Other / uncategorized | 40 | 7 | `container_cache_invalidation_events`, `container_canary_observations`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, ... |
| Platform resources & graph | 63 | 44 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `canonical_capabilities`, `capability_aliases`, `capability_apply_authorization_policy_registry`, `capability_enablement_requests`, `capability_enablement_steps`, `capability_envelope_template_resolutions`, `capability_envelope_templates`, ... |
...
| `v_platform_capability_readiness_vector` | view | Platform resources & graph | 1 | - | - |
