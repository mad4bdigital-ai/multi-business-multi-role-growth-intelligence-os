...
| `act_as_user_sessions` | table | Tenancy & identity | generated_domain_rule | - | 2 | 26 | `tenants` |
...
| `growth_control_config_versions` | table | Governance & authority | registry:growth_control_configuration_objects | `data-model-domain-map`, `observability-release-map`, `platform-resource-graph-map`, `policy-authority-map` | 2 | 30 | `plans`, `tenants` |
...
| `local_connector_device_routes` | table | Workflow & tasks | generated_domain_rule | - | 2 | 26 | `tenants`, `users` |
