...
flowchart LR
  ...
  n_Connectors___providers["Connectors & providers<br/>44 tables / 13 views"]
  n_Delivery___support["Delivery & support<br/>28 tables / 11 views"]
  n_Developer___API["Developer & API<br/>9 tables / 9 views"]
  n_Governance___authority["Governance & authority<br/>41 tables / 6 views"]
  ...
  n_Platform_resources___graph["Platform resources & graph<br/>99 tables / 63 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>39 tables / 12 views"]
...
| Developer & API | 9 | 9 | `admin_platform_endpoint_tools`, `developer_apps`, `endpoints`, `governed_tool_response_chunks`, `offsite_drive_upload_records`, `openapi_endpoint_inventory_sync_runs`, `platform_endpoint_aliases`, `platform_tool_dispatch_bindings`, `uploads`, `v_gpt_schema_db_coverage_issues`, ... |
| Governance & authority | 41 | 6 | `admin_scope_grants`, `auth_email_delivery_attempts`, `auth_password_reset_tokens`, `authority_scope_registry`, `authority_scope_shadow_evidence`, `budget_quota_authority_registry`, `compliance_profiles`, `database_collation_policy_exception_registry`, `database_collation_policy_registry`, `google_ads_budget_execution_gate_audit`, ... |
...
| Tenancy & identity | 39 | 12 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `invitations`, `local_connector_user_configs`, `memberships`, ... |
