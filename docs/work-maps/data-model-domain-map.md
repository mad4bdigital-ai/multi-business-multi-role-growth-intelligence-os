...
| `brands` | table | Brand & business | generated_domain_rule | - | 1 | - | - |
...
| `credential_bindings` | table | Connectors & providers | generated_domain_rule | - | 3 | 20 | `installations`, `tenants`, `users` |
...
| `governed_tool_response_chunks` | table | Developer & API | generated_domain_rule | - | 6 | - | - |
...
| `tenant_platform_endpoint_tools` | table | Tenancy & identity | generated_domain_rule | - | 7 | 16 | - |
| `tenant_relationships` | table | Tenancy & identity | generated_domain_rule | - | 2 | 19 | - |
| `tenant_resolution_case_events` | table | Tenancy & identity | generated_domain_rule | - | 2 | 12 | `tenant_resolution_cases` |
| `tenant_resolution_cases` | table | Tenancy & identity | generated_domain_rule | - | 3 | 28 | `approval_holds`, `tenants`, `tickets` |
| `tenant_resolution_playbooks` | table | Tenancy & identity | generated_domain_rule | - | 1 | 19 | - |
| `tenant_resolution_readbacks` | table | Tenancy & identity | generated_domain_rule | - | 2 | 11 | `tenant_resolution_cases` |
...
| `ticket_lifecycle_events` | table | Delivery & support | generated_domain_rule | - | 3 | 13 | `tenants`, `tickets` |
...
| `tickets` | table | Delivery & support | generated_domain_rule | - | 4 | 27 | `customers`, `tenants`, `threads` |
