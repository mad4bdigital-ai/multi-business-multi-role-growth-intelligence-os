...
flowchart LR
  ...
  n_Other___uncategorized["Other / uncategorized<br/>3 tables / 0 views"]
  ...
  n_Tenancy___identity["Tenancy & identity<br/>30 tables / 7 views"]
...
| Other / uncategorized | 3 | 0 | `growth_dashboard_instruction_registry`, `growth_dashboard_metric_registry`, `growth_dashboard_tab_profile_registry` |
...
| Tenancy & identity | 30 | 7 | `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, `invitations`, `local_connector_user_configs`, `memberships`, `plans`, ... |
