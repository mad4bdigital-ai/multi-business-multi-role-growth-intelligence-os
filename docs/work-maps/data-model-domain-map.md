...
flowchart LR
  ...
  n_Governance___authority["Governance & authority<br/>35 tables / 6 views"]
  ...
  n_Workflow___tasks["Workflow & tasks<br/>33 tables / 4 views"]
```
...
| Workflow & tasks | 33 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `governed_policy_approvals`, `growth_control_activity_pack_definitions`, ... |
