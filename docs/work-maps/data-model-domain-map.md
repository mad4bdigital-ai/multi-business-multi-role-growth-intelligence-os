...
> Source hash: `639dcaeea5977299717c2de5e243309ca4b0d99e616d3a32609129e615976c04`
> Source count: **621**
...
flowchart LR
  ...
  n_Connectors___providers["Connectors & providers<br/>35 tables / 9 views"]
  ...
  n_Platform_resources___graph["Platform resources & graph<br/>62 tables / 44 views"]
...
| Platform resources & graph | 62 | 44 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `canonical_capabilities`, `capability_aliases`, `capability_apply_authorization_policy_registry`, `capability_enablement_requests`, `capability_enablement_steps`, `capability_envelope_templates`, `capability_resolution_envelope_ledger`, ... |
...
| `release_gate_events` | table | Observability & release | 1 | - | `release_operations` |
| `release_operation_evidence` | table | Observability & release | 1 | - | `release_operations` |
| `release_operation_steps` | table | Workflow & tasks | 1 | - | `release_operations` |
...
| `repository_mutation_runs_v6` | table | Other / uncategorized | 1 | 26 | `approval_holds`, `plans`, `tenants`, `users` |
| `repository_operation_leases` | table | Other / uncategorized | 1 | 21 | - |
