...
> Source hash: `929f60aa3a6f6a6689bd25f8a31f3e200a58f9b527b38802fb87e57baf98c6d1`
> Source count: **845**
> Sources: `.specify/work-map-schema-classification-registry.json`, `http-generic-api/migrations/000_aaaaaaaa_mariadb_foreign_key_compatibility_user_credentials_prepare.sql`, `http-generic-api/migrations/000_zzzzzz_mariadb_foreign_key_compatibility_user_credentials.sql`, `http-generic-api/migrations/001_sprint02_tenancy.sql`, `http-generic-api/migrations/002_sprint03_identity.sql`, `http-generic-api/migrations/003_sprint06_access.sql`, `http-generic-api/migrations/003_zzzzzz_mariadb_foreign_key_compatibility_user_credentials_restore.sql`, `http-generic-api/migrations/004_sprint04_customer_ops.sql`, `http-generic-api/migrations/005_sprint07_connected_systems.sql`, `http-generic-api/migrations/006_sprint08_planner.sql`, _... +835 more_
> Rendering: Mermaid plus Markdown tables; no image assets or raw database rows are generated.

```mermaid
flowchart LR
  n_Activation___onboarding["Activation & onboarding<br/>37 tables / 27 views"]
  n_Agents___intelligence["Agents & intelligence<br/>52 tables / 13 views"]
  n_Assets___packages["Assets & packages<br/>18 tables / 0 views"]
  n_Brand___business["Brand & business<br/>10 tables / 0 views"]
  n_Commercial___usage["Commercial & usage<br/>9 tables / 0 views"]
  n_Connectors___providers["Connectors & providers<br/>49 tables / 13 views"]
  n_Delivery___support["Delivery & support<br/>28 tables / 11 views"]
  n_Developer___API["Developer & API<br/>11 tables / 9 views"]
  n_Governance___authority["Governance & authority<br/>46 tables / 6 views"]
  n_Migration___lifecycle["Migration & lifecycle<br/>14 tables / 13 views"]
  n_Observability___release["Observability & release<br/>55 tables / 33 views"]
  n_Platform_resources___graph["Platform resources & graph<br/>100 tables / 63 views"]
  n_Repository___development["Repository & development<br/>38 tables / 13 views"]
  n_Sessions___memory["Sessions & memory<br/>25 tables / 34 views"]
  n_Tenancy___identity["Tenancy & identity<br/>44 tables / 12 views"]
  n_Workflow___tasks["Workflow & tasks<br/>44 tables / 4 views"]
```
...
| Assets & packages | 18 | 0 | `asset_audit_events`, `asset_equivalence_groups`, `asset_equivalence_members`, `json_asset_subject_links`, `pack_attachments`, `platform_copy_locations`, `platform_package_variant_assets`, `platform_package_variant_patches`, `platform_package_variants`, `platform_package_versions`, ... |
| Brand & business | 10 | 0 | `brand_claims`, `brand_identifiers`, `brand_identity_aliases`, `brand_site_bindings`, `brand_skill_policies`, `brand_verification_evidence`, `brands`, `contacts`, `customer_sessions`, `customers` |
...
| Connectors & providers | 49 | 13 | `ads_provider_preflight_contract_registry`, `ads_provider_preflight_surface_blueprint_registry`, `api_credentials`, `app_integration_action_bindings`, `app_integration_tool_bindings`, `app_integrations`, `browser_runtime_artifacts`, `browser_runtime_bindings`, `browser_runtime_events`, `browser_runtime_policy`, ... |
| Delivery & support | 28 | 11 | `auth_email_outbox`, `auth_email_outbox_delivery_attempts`, `external_delivery_provider_adapter_contract_registry`, `external_delivery_provider_adapter_future_pr_scopes`, `external_delivery_provider_adapter_readiness_checklists`, `external_delivery_provider_family_registry`, `external_delivery_provider_send_mode_policy_registry`, `external_delivery_recipient_allowlist_registry`, `output_artifacts`, `platform_closure_threads`, ... |
| Developer & API | 11 | 9 | `admin_platform_endpoint_tools`, `developer_apps`, `endpoints`, `governed_tool_response_chunks`, `offsite_drive_upload_records`, `openapi_endpoint_inventory_sync_runs`, `platform_endpoint_aliases`, `platform_endpoint_tool_exports`, `platform_tool_dispatch_bindings`, `platform_tool_scope_bindings`, ... |
| Governance & authority | 46 | 6 | `admin_scope_grants`, `auth_email_delivery_attempts`, `auth_password_reset_tokens`, `authority_scope_registry`, `authority_scope_shadow_evidence`, `budget_quota_authority_registry`, `compliance_profiles`, `database_collation_policy_exception_registry`, `database_collation_policy_registry`, `execution_policies`, ... |
...
| Observability & release | 55 | 33 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `deployment_attestations`, `dynamic_audit_scheduler_runs`, `execution_log`, `growth_control_activity_binding_readiness_evidence`, `growth_control_decision_evidence`, `growth_control_normalized_metric_observations`, ... |
| Platform resources & graph | 100 | 63 | `adaptation_records`, `ads_provider_capability_profile_registry`, `browser_runtime_capabilities`, `canonical_capabilities`, `canonical_identifier_column_binding_registry`, `canonical_identifier_contract_registry`, `capability_aliases`, `capability_apply_authorization_policy_registry`, `capability_enablement_requests`, `capability_enablement_steps`, ... |
| Repository & development | 38 | 13 | `canonical_resource_registry`, `dev_agent_proposals`, `external_delivery_provider_adapter_enablement_proposals`, `governed_policy_proposals`, `platform_private_repo_mirrors`, `proposal_discussions`, `repo_capability_candidates`, `repo_certification_runs`, `repo_conflict_path_policies`, `repo_conflict_resolution_plans`, ... |
...
| Tenancy & identity | 44 | 12 | `act_as_user_audit_events`, `act_as_user_readbacks`, `act_as_user_sessions`, `actor_profiles`, `assistance_roles`, `execution_plan_events`, `execution_plan_mutation_receipts`, `execution_plan_steps`, `execution_plans`, `governed_research_plan_registry`, ... |
| Workflow & tasks | 44 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `execution_enablement_registry`, `execution_enablement_requests`, `governed_policy_approvals`, `growth_control_activity_pack_definitions`, ... |

## Full schema inventory

| Object | Type | Domain | Classification | Existing map refs | Source migrations | Columns | References |
|---|---|---|---|---|---:|---:|---|
| `act_as_user_audit_events` | table | Tenancy & identity | generated_domain_rule | - | 1 | 14 | `tenants` |
| `act_as_user_readbacks` | table | Tenancy & identity | generated_domain_rule | - | 1 | 10 | `tenants` |
| `act_as_user_sessions` | table | Tenancy & identity | generated_domain_rule | - | 4 | 26 | `tenants` |
| `actions` | table | Workflow & tasks | generated_domain_rule | - | 2 | - | - |
...
| `activation_operational_tile_registry` | table | Activation & onboarding | generated_domain_rule | - | 2 | - | - |
...
| `admin_platform_endpoint_tools` | table | Developer & API | generated_domain_rule | - | 12 | 16 | - |
...
| `agent_skill_grant_requests` | table | Agents & intelligence | generated_domain_rule | - | 3 | - | - |
...
| `app_action_grants` | table | Workflow & tasks | generated_domain_rule | - | 3 | 12 | `agents` |
| `app_action_requests` | table | Workflow & tasks | generated_domain_rule | - | 2 | 15 | `agents` |
| `app_integration_action_bindings` | table | Connectors & providers | generated_domain_rule | - | 2 | 11 | - |
| `app_integration_tool_bindings` | table | Connectors & providers | generated_domain_rule | - | 1 | 12 | - |
| `app_integrations` | table | Connectors & providers | generated_domain_rule | - | 6 | 16 | - |
| `approval_holds` | table | Workflow & tasks | generated_domain_rule | - | 2 | 15 | `step_runs`, `tenants` |
...
| `auth_email_outbox_delivery_attempts` | table | Delivery & support | generated_domain_rule | - | 2 | 20 | `auth_email_outbox` |
...
| `brand_claims` | table | Brand & business | generated_domain_rule | - | 1 | 15 | `brands` |
| `brand_identifiers` | table | Brand & business | generated_domain_rule | - | 1 | 19 | `brands` |
| `brand_identity_aliases` | table | Brand & business | generated_domain_rule | - | 1 | 11 | `brands` |
...
| `brand_verification_evidence` | table | Brand & business | generated_domain_rule | - | 1 | 15 | `brands`, `tenants` |
| `brands` | table | Brand & business | generated_domain_rule | - | 2 | - | - |
...
| `canonical_resource_registry` | table | Repository & development | generated_domain_rule | - | 1 | 14 | - |
...
| `database_table_lifecycle_registry` | table | Migration & lifecycle | generated_domain_rule | - | 2 | - | - |
...
| `deployment_attestations` | table | Observability & release | registry:deployment_attestation_runtime_integrity | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `repository-development-map` | 1 | 18 | - |
...
| `endpoints` | table | Developer & API | generated_domain_rule | - | 2 | - | - |
...
| `execution_policies` | table | Governance & authority | registry:execution_policy_registry | `data-model-domain-map`, `observability-release-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 1 | - | - |
| `external_delivery_provider_adapter_contract_registry` | table | Delivery & support | generated_domain_rule | - | 2 | 20 | `external_delivery_provider_family_registry` |
...
| `external_delivery_provider_family_registry` | table | Delivery & support | generated_domain_rule | - | 2 | 12 | - |
| `external_delivery_provider_send_mode_policy_registry` | table | Delivery & support | generated_domain_rule | - | 2 | 14 | `external_delivery_provider_adapter_contract_registry` |
| `external_delivery_recipient_allowlist_registry` | table | Delivery & support | generated_domain_rule | - | 2 | 13 | `approval_holds`, `tenants` |
...
| `governed_policy_activations` | table | Activation & onboarding | generated_domain_rule | - | 1 | 20 | `governed_policy_invalidation_outbox`, `governed_policy_proposals`, `governed_policy_rollbacks`, `tenants` |
| `governed_policy_answers` | table | Governance & authority | generated_domain_rule | - | 1 | 10 | `governed_policy_sessions` |
| `governed_policy_approvals` | table | Workflow & tasks | generated_domain_rule | - | 1 | 14 | `governed_policy_proposals`, `tenants` |
| `governed_policy_compilations` | table | Governance & authority | generated_domain_rule | - | 1 | 20 | `governed_policy_sessions` |
| `governed_policy_domain_adoptions` | table | Governance & authority | generated_domain_rule | - | 1 | 14 | - |
| `governed_policy_invalidation_outbox` | table | Governance & authority | generated_domain_rule | - | 1 | 18 | `tenants` |
| `governed_policy_proposals` | table | Repository & development | generated_domain_rule | - | 1 | 18 | `governed_policy_compilations`, `tenants` |
| `governed_policy_questionnaire_definitions` | table | Governance & authority | generated_domain_rule | - | 1 | 13 | - |
| `governed_policy_rollbacks` | table | Governance & authority | generated_domain_rule | - | 1 | 16 | `governed_policy_proposals`, `tenants` |
| `governed_policy_safety_bounds` | table | Governance & authority | generated_domain_rule | - | 1 | 13 | - |
| `governed_policy_sessions` | table | Governance & authority | generated_domain_rule | - | 1 | 18 | `governed_policy_questionnaire_definitions`, `tenants`, `users` |
| `governed_policy_versions` | table | Governance & authority | generated_domain_rule | - | 1 | 16 | `governed_policy_proposals`, `tenants` |
| `governed_research_plan_registry` | table | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `governed_tool_response_chunks` | table | Developer & API | generated_domain_rule | - | 3 | - | - |
| `gpt_session_conversation_refs` | table | Sessions & memory | generated_domain_rule | - | 2 | 20 | `tenants`, `users` |
...
| `growth_control_config_versions` | table | Governance & authority | registry:growth_control_configuration_objects | `data-model-domain-map`, `observability-release-map`, `platform-resource-graph-map`, `policy-authority-map` | 4 | 30 | `plans`, `tenants` |
...
| `growth_control_normalized_metric_observations` | table | Observability & release | registry:growth_control_metric_observation_objects | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `policy-authority-map` | 1 | 25 | `tenants` |
| `growth_control_observability_samples` | table | Observability & release | registry:growth_control_metric_observation_objects | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `policy-authority-map` | 1 | 14 | `tenants` |
...
| `local_connector_device_routes` | table | Workflow & tasks | generated_domain_rule | - | 4 | 26 | `tenants`, `users` |
...
| `local_gateway_tool_call_log` | table | Connectors & providers | generated_domain_rule | - | 3 | 26 | `tenants`, `users` |
| `local_gateway_tools` | table | Connectors & providers | generated_domain_rule | - | 5 | 26 | - |
| `local_manager_control_templates` | table | Connectors & providers | registry:local_manager_control_template_registry | `agent-skill-plugin-map`, `connector-provider-map`, `data-model-domain-map`, `policy-authority-map` | 1 | 14 | - |
| `local_manager_desktop_commands` | table | Workflow & tasks | registry:local_manager_desktop_command_queue | `connector-provider-map`, `data-model-domain-map`, `execution-log-evidence-map`, `workflow-task-orchestration-map` | 1 | 22 | `tenants`, `users` |
| `local_manager_device_link_sessions` | table | Connectors & providers | generated_domain_rule | - | 2 | 21 | `tenants`, `users` |
...
| `logic_definitions` | table | Agents & intelligence | generated_domain_rule | - | 1 | 15 | `tenants` |
| `logic_packs` | table | Agents & intelligence | generated_domain_rule | - | 1 | 11 | `tenants` |
| `managed_execution_bindings` | table | Workflow & tasks | registry:tenant_managed_execution_bindings | `activation-access-map`, `data-model-domain-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 1 | - | - |
| `managed_execution_events` | table | Observability & release | registry:tenant_managed_execution_events | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `workflow-task-orchestration-map` | 1 | - | - |
| `managed_execution_step_requests` | table | Workflow & tasks | generated_domain_rule | - | 1 | - | - |
| `managed_google_oauth_audit` | table | Connectors & providers | generated_domain_rule | - | 1 | - | - |
| `managed_google_oauth_request_nonces` | table | Connectors & providers | generated_domain_rule | - | 1 | - | - |
| `managed_google_oauth_sessions` | table | Connectors & providers | generated_domain_rule | - | 1 | - | - |
| `memberships` | table | Tenancy & identity | generated_domain_rule | - | 1 | 7 | `tenants`, `users` |
| `memory_scope_links` | table | Sessions & memory | generated_domain_rule | - | 3 | 36 | `memory_scope_type_registry`, `tenants`, `users` |
...
| `platform_capability_certifications` | table | Platform resources & graph | generated_domain_rule | - | 2 | 17 | - |
...
| `platform_capability_readback_contracts` | table | Platform resources & graph | generated_domain_rule | - | 4 | 24 | - |
| `platform_capability_source_links` | table | Platform resources & graph | generated_domain_rule | - | 2 | 11 | - |
...
| `platform_configuration_bindings` | table | Governance & authority | registry:platform_configuration_control_plane_objects | `data-model-domain-map`, `observability-release-map`, `platform-resource-graph-map`, `policy-authority-map` | 1 | - | - |
| `platform_configuration_catalog` | table | Governance & authority | registry:platform_configuration_control_plane_objects | `data-model-domain-map`, `observability-release-map`, `platform-resource-graph-map`, `policy-authority-map` | 1 | - | - |
| `platform_configuration_resolution_evidence` | table | Observability & release | generated_domain_rule | - | 1 | - | - |
...
| `platform_endpoint_tool_exports` | table | Developer & API | generated_domain_rule | - | 1 | - | - |
| `platform_engine_execution_runs` | table | Agents & intelligence | generated_domain_rule | - | 2 | - | - |
| `platform_engine_policy_registry` | table | Agents & intelligence | generated_domain_rule | - | 2 | - | - |
| `platform_engine_policy_rules` | table | Agents & intelligence | generated_domain_rule | - | 1 | - | - |
| `platform_engine_registry` | table | Agents & intelligence | generated_domain_rule | - | 2 | - | - |
...
| `platform_evidence_events` | table | Observability & release | generated_domain_rule | - | 2 | 22 | - |
...
| `platform_outbox_event_types` | table | Delivery & support | registry:platform_outbox_delivery | `data-model-domain-map`, `delivery-support-map`, `observability-release-map`, `workflow-task-orchestration-map` | 2 | - | - |
...
| `platform_plugin_bindings` | table | Agents & intelligence | generated_domain_rule | - | 2 | 13 | - |
| `platform_plugin_capabilities` | table | Platform resources & graph | generated_domain_rule | - | 4 | 21 | - |
| `platform_plugin_capability_exports` | table | Platform resources & graph | generated_domain_rule | - | 3 | 12 | - |
...
| `platform_resource_adapters` | table | Platform resources & graph | generated_domain_rule | - | 2 | 16 | - |
...
| `platform_resource_recipe_steps` | table | Platform resources & graph | generated_domain_rule | - | 2 | 18 | - |
| `platform_resource_recipes` | table | Platform resources & graph | generated_domain_rule | - | 1 | 21 | - |
| `platform_resource_scope_bindings` | table | Platform resources & graph | generated_domain_rule | - | 1 | - | - |
...
| `platform_runtime_config` | table | Platform resources & graph | generated_domain_rule | - | 3 | 6 | - |
| `platform_scope_catalog_revisions` | table | Governance & authority | registry:remote_mcp_scope_catalog_governance | `data-model-domain-map`, `platform-resource-graph-map`, `policy-authority-map` | 1 | - | - |
| `platform_scope_implications` | table | Governance & authority | registry:remote_mcp_scope_catalog_governance | `data-model-domain-map`, `platform-resource-graph-map`, `policy-authority-map` | 1 | - | - |
...
| `platform_tool_dispatch_bindings` | table | Developer & API | generated_domain_rule | - | 4 | - | - |
| `platform_tool_scope_bindings` | table | Developer & API | generated_domain_rule | - | 1 | - | - |
...
| `remote_runtime_targets` | table | Connectors & providers | generated_domain_rule | - | 2 | 21 | `tenants`, `users` |
...
| `repo_certification_runs` | table | Repository & development | generated_domain_rule | - | 2 | - | - |
...
| `repository_advisory_comment_plans` | table | Repository & development | registry:repository_automation_control_plane | `data-model-domain-map`, `observability-release-map`, `repository-automation-map`, `repository-development-map` | 1 | - | - |
...
| `repository_authority_bindings` | table | Repository & development | registry:repository_automation_control_plane | `data-model-domain-map`, `observability-release-map`, `repository-automation-map`, `repository-development-map` | 2 | - | - |
...
| `repository_main_moved_trigger_events` | table | Repository & development | registry:repository_automation_control_plane | `data-model-domain-map`, `observability-release-map`, `repository-automation-map`, `repository-development-map` | 1 | - | - |
...
| `repository_mutation_runs_v6` | table | Repository & development | registry:repository_automation_control_plane | `data-model-domain-map`, `observability-release-map`, `repository-automation-map`, `repository-development-map` | 1 | 26 | `approval_holds`, `plans`, `tenants`, `users` |
...
| `runtime_break_glass_audit_events` | table | Observability & release | generated_domain_rule | - | 1 | - | `runtime_break_glass_incidents` |
| `runtime_break_glass_incidents` | table | Observability & release | generated_domain_rule | - | 2 | - | - |
...
| `runtime_dispatch_certification_registry` | table | Observability & release | generated_domain_rule | - | 2 | 19 | - |
...
| `skill_packages` | table | Assets & packages | generated_domain_rule | - | 1 | 12 | - |
...
| `staging_activation_gateway_envelope_plan_bindings` | table | Activation & onboarding | generated_domain_rule | - | 1 | - | - |
| `staging_activation_gateway_execution_artifacts` | table | Activation & onboarding | generated_domain_rule | - | 1 | - | - |
| `staging_activation_gateway_execution_plans` | table | Activation & onboarding | generated_domain_rule | - | 1 | - | - |
| `step_runs` | table | Workflow & tasks | generated_domain_rule | - | 2 | 15 | `tenants` |
| `storage_authorized_injection_rollbacks` | table | Observability & release | registry:spec014_hostinger_storage_authorized_injection_rollbacks | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `policy-authority-map` | 1 | - | `storage_authorized_injection_states` |
| `storage_authorized_injection_states` | table | Governance & authority | registry:spec014_hostinger_storage_authorized_injection_states | `data-model-domain-map`, `execution-log-evidence-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 1 | - | - |
...
| `storage_cleanup_operations` | table | Workflow & tasks | registry:spec014_hostinger_storage_cleanup_operations | `data-model-domain-map`, `execution-log-evidence-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 2 | - | `storage_provider_accounts`, `storage_targets` |
...
| `storage_execution_leases` | table | Governance & authority | registry:spec014_hostinger_storage_execution_leases | `data-model-domain-map`, `execution-log-evidence-map`, `policy-authority-map`, `workflow-task-orchestration-map` | 3 | - | `storage_cleanup_operations`, `storage_targets` |
| `storage_pressure_incidents` | table | Delivery & support | registry:spec014_hostinger_storage_pressure_incidents | `data-model-domain-map`, `delivery-support-map`, `execution-log-evidence-map`, `observability-release-map` | 1 | - | `storage_provider_accounts`, `storage_targets` |
...
| `support_ticket_dedupe_claims` | table | Delivery & support | generated_domain_rule | - | 1 | - | - |
...
| `tenant_brand_links` | table | Tenancy & identity | generated_domain_rule | - | 3 | 8 | `tenants` |
...
| `tenant_gpt_oauth_grants` | table | Tenancy & identity | generated_domain_rule | - | 1 | 15 | `tenants`, `users` |
| `tenant_gpt_sso_sessions` | table | Tenancy & identity | generated_domain_rule | - | 2 | 11 | `tenants`, `users` |
| `tenant_growth_recommendation_events` | table | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `tenant_integration_policies` | table | Tenancy & identity | generated_domain_rule | - | 2 | 13 | `tenants` |
| `tenant_package_installs` | table | Assets & packages | generated_domain_rule | - | 1 | - | - |
| `tenant_platform_endpoint_tools` | table | Tenancy & identity | generated_domain_rule | - | 6 | 16 | - |
| `tenant_relationships` | table | Tenancy & identity | generated_domain_rule | - | 2 | 19 | - |
| `tenant_resolution_case_events` | table | Tenancy & identity | generated_domain_rule | - | 1 | 12 | `tenant_resolution_cases` |
| `tenant_resolution_cases` | table | Tenancy & identity | generated_domain_rule | - | 2 | 28 | `approval_holds`, `tenants`, `tickets` |
...
| `ticket_lifecycle_events` | table | Delivery & support | generated_domain_rule | - | 2 | 13 | `tenants`, `tickets` |
...
| `ticket_workflow_links` | table | Delivery & support | generated_domain_rule | - | 1 | 12 | `approval_holds`, `plans`, `tenants`, `tickets` |
| `tickets` | table | Delivery & support | generated_domain_rule | - | 3 | 27 | `customers`, `tenants`, `threads` |
...
| `user_app_connections` | table | Tenancy & identity | generated_domain_rule | - | 9 | 19 | `tenants`, `users` |
| `user_brand_skill_grants` | table | Tenancy & identity | generated_domain_rule | - | 2 | - | - |
| `user_credentials` | table | Tenancy & identity | generated_domain_rule | - | 4 | 6 | `users` |
| `users` | table | Tenancy & identity | generated_domain_rule | - | 2 | 7 | - |
...
| `workflow_runtime_bindings` | table | Workflow & tasks | generated_domain_rule | - | 2 | 20 | `tenants` |
| `workflows` | table | Workflow & tasks | generated_domain_rule | - | 2 | - | - |
| `workspace_access_requests` | table | Tenancy & identity | generated_domain_rule | - | 3 | - | - |
| `workspace_app_links` | table | Tenancy & identity | generated_domain_rule | - | 4 | 10 | `tenants` |
...
| `workspace_resource_grants` | table | Tenancy & identity | generated_domain_rule | - | 4 | - | - |
| `workspace_vaults` | table | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `write_route_policy_audit` | table | Workflow & tasks | generated_domain_rule | - | 1 | 10 | `write_route_policy_registry` |
| `write_route_policy_registry` | table | Workflow & tasks | generated_domain_rule | - | 1 | 23 | - |
...
| `v_canonical_resource_activation_registry` | view | Activation & onboarding | generated_domain_rule | - | 1 | - | - |
...
| `v_github_issue_comment_dispatch_parity` | view | Repository & development | generated_domain_rule | - | 1 | - | - |
| `v_github_issue_comment_exact_response_parity` | view | Repository & development | generated_domain_rule | - | 1 | - | - |
| `v_governed_response_chunk_ownership_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
| `v_governed_response_chunk_runtime_schema_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
| `v_governed_response_chunk_schema_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
| `v_governed_response_chunk_transport_schema_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
...
| `v_managed_execution_lifecycle_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
...
| `v_platform_semantic_capability_canonical_reconciliation` | view | Platform resources & graph | generated_domain_rule | - | 1 | - | - |
...
| `v_platform_virtual_tool_bindings_current` | view | Developer & API | generated_domain_rule | - | 2 | - | - |
| `v_platform_virtual_tool_capabilities_current` | view | Platform resources & graph | generated_domain_rule | - | 2 | - | - |
| `v_platform_virtual_tool_capability_gaps` | view | Platform resources & graph | generated_domain_rule | - | 2 | - | - |
| `v_platform_virtual_tool_exports_current` | view | Developer & API | generated_domain_rule | - | 3 | - | - |
| `v_platform_virtual_tool_identity_resolution` | view | Developer & API | generated_domain_rule | - | 2 | - | - |
...
| `v_remaining_tenant_runtime_lifecycle_gap_readiness` | view | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
...
| `v_repository_reconciliation_apply_readiness` | view | Repository & development | generated_domain_rule | - | 1 | - | - |
...
| `v_runtime_endpoint_schema_coverage` | view | Developer & API | generated_domain_rule | - | 1 | - | - |
...
| `v_storage_admin_target_readiness` | view | Observability & release | generated_domain_rule | - | 1 | - | - |
| `v_storage_cleanup_operation_readback` | view | Observability & release | registry:spec014_hostinger_storage_cleanup_operation_readback | `data-model-domain-map`, `execution-log-evidence-map`, `observability-release-map`, `workflow-task-orchestration-map` | 1 | - | - |
| `v_storage_tenant_target_readiness` | view | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `v_superseded_branch_cleanup_policy_readback` | view | Repository & development | generated_domain_rule | - | 2 | - | - |
| `v_support_ticket_integrity_readiness` | view | Delivery & support | generated_domain_rule | - | 1 | - | - |
| `v_support_ticket_latest_activity` | view | Delivery & support | generated_domain_rule | - | 1 | - | - |
| `v_tenant_effective_capability_candidates` | view | Platform resources & graph | generated_domain_rule | - | 1 | - | - |
| `v_tenant_platform_plugin_managed_repair_readiness` | view | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `v_tenant_request_inbox_schema_readiness` | view | Tenancy & identity | generated_domain_rule | - | 1 | - | - |
| `v_wordpress_action_surface_contract` | view | Connectors & providers | generated_domain_rule | - | 1 | - | - |
| `v_wordpress_action_surface_reconciliation` | view | Connectors & providers | generated_domain_rule | - | 1 | - | - |
| `v_wordpress_registry_runtime_reconciliation` | view | Connectors & providers | generated_domain_rule | - | 1 | - | - |
