...
> Source hash: `4e3e4e4d8beee676d2b3343eba335fa5cdd68e3cfec22017cc29ec2c719ff4bd`
> Source count: **623**
...
flowchart LR
  ...
  n_Observability___release["Observability & release<br/>27 tables / 29 views"]
  ...
  n_Workflow___tasks["Workflow & tasks<br/>27 tables / 4 views"]
```
...
| Observability & release | 27 | 29 | `audit_log`, `audit_payload_evidence`, `connected_execution_evidence_reports`, `db_change_audit_events`, `dynamic_audit_scheduler_runs`, `execution_log`, `incidents`, `local_app_releases`, `platform_audit_event_bus`, `platform_backup_artifact_manifests`, ... |
...
| Workflow & tasks | 27 | 4 | `actions`, `app_action_grants`, `app_action_requests`, `approval_holds`, `browser_data_extraction_jobs`, `connected_execution_resume_actions`, `container_override_approvals`, `execution_enablement_registry`, `execution_enablement_requests`, `local_connector_app_routes`, ... |
