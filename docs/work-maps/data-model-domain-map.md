...
> Source hash: `545cb93ea8ba9b3c503f3b7b158d5c732e574f4cee2f99f61098cf8f4a539606`
> Source count: **717**
...
flowchart LR
  ...
  n_Agents___intelligence["Agents & intelligence<br/>49 tables / 10 views"]
  ...
  n_Other___uncategorized["Other / uncategorized<br/>43 tables / 9 views"]
...
| Agents & intelligence | 49 | 10 | `agent_chain_events`, `agent_delegations`, `agent_handoff_state_access_log`, `agent_handoff_state_registry`, `agent_logic_pack_bindings`, `agent_model_runs`, `agent_response_profile_registry`, `agent_skill_grant_requests`, `agent_skill_grants`, `agent_skills`, ... |
...
| Other / uncategorized | 43 | 9 | `container_cache_invalidation_events`, `container_canary_observations`, `container_classification_type_registry`, `container_classifications`, `container_closure`, `container_effective_context_ledger`, `container_identity_projection_issues`, `container_override_consumptions`, `container_override_requests`, `container_projection_runs`, ... |
...
| `agent_skill_grant_requests` | table | Agents & intelligence | 1 | - | - |
...
| `auth_email_outbox` | table | Delivery & support | 2 | 14 | - |
