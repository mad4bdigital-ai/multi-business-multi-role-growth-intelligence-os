...
> Source hash: `26524489440520bb4bfead95806ab483270412fdacc1e9cc6682823d019672df`
> Source count: **27**
...
flowchart TD
  ...
  n_Workspace_Lifecycle_Final_Sync["Workspace Lifecycle Final Sync"]
  n_Workspace_Lifecycle_Mutation_Bootstrap["Workspace Lifecycle Mutation Bootstrap"]
  ...
  Change --> n_Workspace_Lifecycle_Final_Sync
  Change --> n_Workspace_Lifecycle_Mutation_Bootstrap
  PR --> CI[CI validation]
  PR --> Docs[Docs Agent]
...
| Workspace Lifecycle Final Sync | `.github/workflows/workspace-lifecycle-final-sync.yml` | `push` |
| Workspace Lifecycle Mutation Bootstrap | `.github/workflows/workspace-lifecycle-mutation-bootstrap.yml` | `pull_request` |
