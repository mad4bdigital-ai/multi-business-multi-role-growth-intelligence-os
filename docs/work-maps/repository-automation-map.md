...
| Workspace Lifecycle Final Sync | `.github/workflows/workspace-lifecycle-final-sync.yml` | manual/other |
| Workspace Lifecycle Mutation Bootstrap | `.github/workflows/workspace-lifecycle-mutation-bootstrap.yml` | `pull_request` |

Workflow files discovered: **24**.
