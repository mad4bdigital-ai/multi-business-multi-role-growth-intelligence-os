...
flowchart TD
  ...
  n_Surface_Contract_Phase_A_Current_Main_Rebuild["Surface Contract Phase A Current Main Rebuild"]
  ...
  Change --> n_Surface_Contract_Phase_A_Current_Main_Rebuild
...
| Surface Contract Phase A Current Main Rebuild | `.github/workflows/surface-contract-phase-a-current-main-rebuild.yml` | manual/other |
| Verify Runtime | `.github/workflows/verify-runtime.yml` | `workflow_dispatch` |

Workflow files discovered: **27**.
