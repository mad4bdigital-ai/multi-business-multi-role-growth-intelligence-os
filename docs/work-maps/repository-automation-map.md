...
> Source hash: `1dfc358d741b1c6b3936dc7e2a0f87b2a55bd72e33be96196fa41c5607b85f09`
> Source count: **11**
> Sources: `.github/workflows/ci.yml`, `.github/workflows/docs-agent.yml`, `.github/workflows/dr-certification-readiness.yml`, `.github/workflows/local-manager-windows.yml`, `.github/workflows/openapi-auto-sync.yml`, `.github/workflows/platform-completion-cleanup-readback.yml`, `.github/workflows/platform-remaining-scope-scorecard.yml`, `.github/workflows/pr-risk-labeler.yml`, `.github/workflows/pr1569-finalize.yml`, `.github/workflows/surface-contract-auto-remediation.yml`, `.github/workflows/verify-runtime.yml`
...
flowchart TD
  ...
  n_PR_1569_Finalize["PR 1569 Finalize"]
...
| PR 1569 Finalize | `.github/workflows/pr1569-finalize.yml` | `push` |
