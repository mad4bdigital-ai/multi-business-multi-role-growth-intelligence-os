...
- `1014_sprint69_approval_hold_collation_reconciliation_rule.sql` — high_review, score 466; add targeted patch-index, parity, and governance documentation
