...
- `20260723_auth_email_outbox_skip_ineligible_tool.sql` — critical_review, score 931; classify route-like strings, then add OpenAPI contract or false-positive exemption
