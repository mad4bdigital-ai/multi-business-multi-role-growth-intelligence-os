...
| Metric | Value |
|---|---:|
| Tracked files scanned | 7311 |
| Routes discovered | 1083 |
| Write routes discovered | 657 |
| Classified write-surface candidates | 40 |
| Classified write routes | 657 |
| Intentionally unmapped write routes (blocked) | 617 |
...
- **high** `INTENTIONALLY_UNMAPPED_WRITE_ROUTES_BLOCKED` — count: 617 — sensitive: 617
