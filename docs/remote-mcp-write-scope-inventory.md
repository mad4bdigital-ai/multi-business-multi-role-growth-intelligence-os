...
| Metric | Value |
|---|---:|
| Tracked files scanned | 7033 |
| Routes discovered | 1079 |
| Write routes discovered | 656 |
| Classified write-surface candidates | 38 |
| Classified write routes | 656 |
| Intentionally unmapped write routes (blocked) | 618 |
...
- **high** `INTENTIONALLY_UNMAPPED_WRITE_ROUTES_BLOCKED` — count: 618 — sensitive: 618
