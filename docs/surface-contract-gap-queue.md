...
### 1. `20260704_runtime_dispatch_certification_issuer.sql`
...
- Surface counts: plugins=0, tools=6, views=0, policies=0, routes=0
- Remediation actions:
...
- `verify_tool_registry_binding` → runtime-registry-review; targets: `requires_readback`, `runtime_dispatch_certification_issue`, `runtime_dispatch_certification_issue_bootstrap_v1`, `runtime_dispatch_certification_issue_v1`, `runtime_dispatch_certification_registry`, `unit_test_and_policy_bootstrap_readback`
