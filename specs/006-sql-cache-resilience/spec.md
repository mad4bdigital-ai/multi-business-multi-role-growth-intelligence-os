# Historical Specification: SQL Cache Resilience
...
The current operational authority is [`docs/runbooks/sql-cache-operations.md`](../../docs/runbooks/sql-cache-operations.md).
