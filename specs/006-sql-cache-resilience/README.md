# Spec Kit 006 — SQL Cache Resilience
...
- `spec.md` — the curated historical specification, retained requirements, implemented architecture, and evidence map.
- [`docs/runbooks/sql-cache-operations.md`](../../docs/runbooks/sql-cache-operations.md) — the current operational authority for policy reads and updates, diagnostics, rollback, migration authorization, and incident response.
