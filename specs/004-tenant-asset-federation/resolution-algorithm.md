...
```text
business_type_binding_not_found
business_type_binding_inactive
inheritance_profile_not_found
inheritance_profile_ambiguous
layer_type_unregistered
layer_relationship_type_unregistered
blueprint_not_found
blueprint_not_eligible
blueprint_required_missing
blueprint_dependency_missing
blueprint_conflict
blueprint_equivalence_ambiguous
blueprint_version_incompatible
blueprint_security_revoked
blueprint_upgrade_review_required
layer_graph_cycle
layer_graph_limit_exceeded
layer_instance_cross_brand_forbidden
layer_instance_provenance_missing
layer_removal_disposition_required
inheritance_version_changed
