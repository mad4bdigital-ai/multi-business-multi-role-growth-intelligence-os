...
- `artifact-knowledge-provenance-decision.md` — approved policy-bound, cryptographically attested, claim-level verifiable knowledge fabric: immutable content-addressed versions, source/claim/citation provenance, multi-dimensional trust, conservative policy inheritance, reproducibility, selective disclosure, versioned knowledge builds, and correction/retraction/disposition propagation.
