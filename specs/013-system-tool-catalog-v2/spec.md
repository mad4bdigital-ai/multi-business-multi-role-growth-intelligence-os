...
- **FR-011:** Observability MUST count list, direct lookup, misses, legacy requests, resolution, snapshot mismatch, and descriptor/runtime mismatch without secrets.
