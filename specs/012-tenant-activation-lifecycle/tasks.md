...
- [x] **T018** `[ADR-005]` Finalize generic questionnaire/session/answer/compilation/proposal/preview/approval/activation/readback/rollback API and JSON Schema contracts. Evidence: governed policy API/schema contracts merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; exact-head verification and post-merge ancestry are recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json` and regression `http-generic-api/test-spec012-policy-closeout-and-t026-readiness.mjs`.
- [x] **T019** `[ADR-005]` Finalize domain safety-bound registry, deterministic compiler contract, risk-to-approval matrix, version provenance, cache-invalidation policy, and platform domain-adoption gate. Evidence: governed registry/compiler/approval/version/cache/domain-adoption contracts merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; closeout and exact-head verification are recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
...
- [x] **T024B** `[ADR-005][ADR-006]` Implement versioned `deployment_evidence_exposure_policy` questionnaire adapter, immutable principal exposure ceilings, exact-version registry readback, and critical cache invalidation. Evidence: implementation and regressions merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; task completion and exact-head checks are recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
- [x] **T025** `[FR-037][concerns]` Implement operational attention projection rules. Evidence: operational-attention implementation and regressions merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; task completion and post-merge ancestry are recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
- [ ] **T026** `[migration]` Add governed additive migration and readback if inventory requires schema change. Readiness evidence: repository designs for `20260731_governed_policy_questionnaire_foundation.sql` and `20260731_governed_policy_registry_authority.sql`, checksum/static-preflight reporting, and regression coverage merged through PR #5049 at `c60dcfc81fa925751c7dfe75ab355ea71b7e74a3`. Still blocked: no checksum-bound authorization, Apply, migration-ledger readback, or schema readback has occurred.
...
- [x] **T029A** `[ADR-005]` Implement versioned questionnaire definitions, context-aware question selection, pinned answer sessions, and schema validation. Evidence: implementation and regressions merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; closeout is recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
- [x] **T029B** `[ADR-005]` Implement deterministic policy compilation, immutable safety-bound validation, impact preview, risk classification, and approval resolution. Evidence: implementation and regressions merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; closeout is recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
- [x] **T029C** `[ADR-005]` Implement governed policy proposal activation, exact-version SQL registry readback, cache invalidation, supersession, and rollback. Evidence: implementation and regressions merged through PR #4181 at `78c497c5a0f71df297cac0e204acd2044374872c`; closeout is recorded in `implementation/pr-2h-policy-post-merge-and-t026-readiness.json`.
