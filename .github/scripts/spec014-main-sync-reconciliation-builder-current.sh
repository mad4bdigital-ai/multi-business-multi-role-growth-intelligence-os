...
report = {
    'contract': 'spec014.current-main-sync-reconciliation-builder.v1',
...
lines = [
    '## Spec 014 current-main reconciliation builder',
    '',
...
conflict_set_sha256="$(sha256sum "$REPORT_DIR/conflict-paths.txt" | awk '{print $1}')"
