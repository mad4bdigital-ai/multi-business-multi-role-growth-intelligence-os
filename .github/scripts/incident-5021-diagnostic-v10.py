...
SOURCE_COMMIT = "681a6a3bf8750276a25994584ef4b461caf9ce84"
SOURCE_DIAGNOSTIC = ".github/workflows/incident-5021-exact-head-approval-builder-diagnostic-v6.yml"
OLD_TARGET_SHA = "2c89cc14d8a38a09034f0306eccff273234046e2"
EXPECTED_TARGET_SHA = "2b7cf14b23c03df97a962b6451cbb4579a39d628"
REPORT_PATH = "incident-5021-builder-diagnostic-v10.json"


def extract_v6_source() -> str:
    raw = subprocess.check_output(
        ["git", "show", f"{SOURCE_COMMIT}:{SOURCE_DIAGNOSTIC}"],
        text=True,
    ...
    return textwrap.dedent(raw[start:end]).replace(OLD_TARGET_SHA, EXPECTED_TARGET_SHA)
...
'''
    ...
    source = source.replace(
        ...
        "incident_5021_exact_head_approval_builder_v10",
    )
    source = source.replace(
        "incident-5021-builder-diagnostic-v6.py",
        "incident-5021-builder-diagnostic-v10.py",
    )
    return source
...
def main() -> int:
    ...
    driver_path = Path("/tmp/incident-5021-diagnostic-driver-v10.py")
