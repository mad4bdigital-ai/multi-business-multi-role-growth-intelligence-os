...
-- DRAFT ROLLBACK PLAN ONLY; contract-local; no destructive statement is executed by this file.
-- Task: T027
...
SELECT
  'spec014_hostinger_storage_rollback_pre_live_v3' AS contract_key,
