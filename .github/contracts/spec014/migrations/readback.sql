...
SELECT
  ...
  CASE
    WHEN SUM(t.table_name IS NOT NULL AND t.table_type = 'BASE TABLE' AND t.engine = 'InnoDB' AND t.table_collation = 'utf8mb4_unicode_ci') = 15
...
SELECT
  'spec014_hostinger_storage_migration_readback_v3' AS contract_key,
