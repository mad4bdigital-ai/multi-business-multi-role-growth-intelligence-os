/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.staging.jsonc` (hash: 6ed8a60f5fe05df60a1034e6624452b0)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-staging");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACTIVATION_GATEWAY_ENFORCE_HOST">> {}
}
