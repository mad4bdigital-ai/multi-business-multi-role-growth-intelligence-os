...
const ENV_PS_ENABLED = process.env.CONNECTOR_POWERSHELL_ENABLED === 'true';
const ENV_WIN_ENABLED = process.env.CONNECTOR_WIN_ENABLED === 'true';
let PS_ENABLED = ENV_PS_ENABLED;
let WIN_ENABLED = ENV_WIN_ENABLED;
...
const ENV_AUTO_BROWSER_ENABLED = process.env.CONNECTOR_AUTO_BROWSER_ENABLED === 'true';
let AUTO_BROWSER_ENABLED = ENV_AUTO_BROWSER_ENABLED;
