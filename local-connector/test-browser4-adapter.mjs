...
import { buildBrowser4InspectionScript, parseBrowser4AllowedHosts, sanitizeBrowser4Checks, validateBrowser4Url } from './browser4-adapter.mjs';

assert.deepEqual(parseBrowser4AllowedHosts('mad4b.com, n8n.mad4b.com'), ['mad4b.com', 'n8n.mad4b.com']);
assert.equal(validateBrowser4Url('https://n8n.mad4b.com/', ['mad4b.com']).host, 'n8n.mad4b.com');
...
const built = buildBrowser4InspectionScript({ url: 'https://n8n.mad4b.com/', checks: ['snapshot', 'screenshot'], runKey: 'smoke/unsafe key', workDir: 'D:\\n8n-data\\browser-runtime-artifacts', javaHome: 'D:\\n8n-data\\browser-runtime\\jre17\\jdk-17.0.19+10-jre' });
