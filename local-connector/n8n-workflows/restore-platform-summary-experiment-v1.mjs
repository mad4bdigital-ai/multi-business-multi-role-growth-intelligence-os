...
const templatePath = path.resolve(__dirname, 'platform-summary-experiment-v1.template.json');
...
async function smokeTest() {
  const webhookUrl = `${n8nBase}/webhook/platform-summary-experiment`;
  const response = await fetch(webhookUrl, {
    ...
    body: JSON.stringify({
      input: {
        text: 'Restored summary experiment smoke test. This should return a quick preview only.',
