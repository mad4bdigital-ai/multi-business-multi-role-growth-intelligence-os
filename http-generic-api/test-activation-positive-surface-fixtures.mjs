...
const migration = readFileSync(new URL("./migrations/276_sprint68_activation_positive_surface_fixtures.sql", import.meta.url), "utf8");
...
assert.match(runner, /276_sprint68_activation_positive_surface_fixtures\.sql/);
...
for (const surface of ["agent_skill_grants", "connected_app_connections", "workflow_runtime_bindings", "plugin_contributions", "pending_tasks", "app_action_grants", "tenant_integration_policies"]) {
