...
assert.match(metadataState, /github_repository_policy_1051_metadata_diagnostic\.v3/);
assert.match(metadataState, /github_repository_policy_1051_envelope_dependency_225\.v1/);
...
assert.match(metadataState, /dependency_ready/);
