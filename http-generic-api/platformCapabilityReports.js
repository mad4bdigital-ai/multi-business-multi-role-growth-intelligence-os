...
export async function buildPlatformCapabilityContractReport(_args = {}, deps = {}) {
  ...
  const checks = [
    ...
    contractCheck({
      ...
      title: "Resource authority requirements and effective bindings",
    ...
    contractCheck({
      ...
      title: "Capability provenance and source resolution",
      required: ["platform_capability_source_links", "platform_capability_source_resolutions", "repo_capability_candidates"],
      objectSet,
      toolSet,
    }),
    contractCheck({
...
export async function buildPlatformCapabilityLiveReport(args = {}, deps = {}) {
  ...
  const [clock, totals, maturity, gaps, envelopeStatuses, executionStatuses, certifications, sourceResolutions, debtStatuses, gapRows] = await Promise.all([
    ...
    groupedCounts(pool, "platform_capability_source_links", ["resolution_status"]),
