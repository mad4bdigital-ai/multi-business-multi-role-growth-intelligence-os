...
assert.match(source, /FROM platform_tool_dispatch_bindings/);
assert.match(source, /expected_binding_count/);
assert.match(source, /result\.binding_count === result\.expected_binding_count/);
assert.match(source, /result\.expected_binding_count > 0/);
assert.doesNotMatch(source, /result\.binding_count === 14/);
