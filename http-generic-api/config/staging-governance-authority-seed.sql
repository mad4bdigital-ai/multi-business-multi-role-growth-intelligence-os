-- staging-governance-authority-seed.sql
-- Local Staging Governance DB only.
-- Replays the exact profile-owned Staging Activation Gateway authority rows after
-- schema-only database recovery. It never calls Cloudflare, changes grants, mutates
-- DNS/custom domains, touches Production, or returns provider secrets.
...
('5a2b04f8-bb99-4f65-a924-0f55d3080376',
 ...
 'system:staging-recovery:governance-authority-seed')
ON DUPLICATE KEY UPDATE
