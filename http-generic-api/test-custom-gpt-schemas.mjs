...
section("admin and tenant OpenAI schema coverage for tool additions");
{
  ...
  const migration188 = readFileSync(resolve(__dirname, "migrations/188_sprint66_hostinger_db_name_intake_autopromotion.sql"), "utf8");
  ...
  assert("remote runtime requires DB_NAME alongside Hostinger SSH credentials",
    remoteRuntime.includes('"ssh_private_key", "db_name"'));
