...
const cases = [
  ...
  ["local_device_disabled", { ...base, config: { ...trustedConfig, is_enabled: 0, lifecycle_state: "disabled" } }],
  ["local_device_revoked", { ...base, config: { ...trustedConfig, lifecycle_state: "revoked", revoked_at: "2026-06-19T23:00:00.000Z" } }],
  ["local_device_archived", { ...base, config: { ...trustedConfig, lifecycle_state: "archived", archived_at: "2026-06-19T22:00:00.000Z" } }],
  ["local_device_lifecycle_invalid", { ...base, config: { ...trustedConfig, lifecycle_state: "unknown" } }],
