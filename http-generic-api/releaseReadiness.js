...
const REQUIRED_RUNTIME_POLICY_SEEDS = [
  ...
  { check_key: "support_ticket_orchestration_completion_readbacks", policy_group: "Orchestration Intelligence Governance", policy_key: "support_ticket_orchestration_completion_readbacks_policy_v1", required_blocking: true, required_scope_tokens: ["support_ticket_lifecycle", "support_ticket_external_delivery", "next_action_readback"], required_affects_layer_tokens: ["supportTicketLifecycleNextActionReadback", "supportTicketExternalDeliveryOrchestrationReadback", "platformPluginRoutes"] },
  { check_key: "support_ticket_external_delivery_orchestration_readback", policy_group: "Orchestration Intelligence Governance", policy_key: "support_ticket_external_delivery_orchestration_readback_policy_v1", required_blocking: true, required_scope_tokens: ["support_ticket_external_delivery", "orchestration_readback", "external_delivery_readiness"], required_affects_layer_tokens: ["supportTicketExternalDeliveryOrchestrationReadback", "platformOrchestrationReadback", "platform_orchestration_stages"] },
