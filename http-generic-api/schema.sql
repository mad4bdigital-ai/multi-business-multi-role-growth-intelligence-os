...
CREATE TABLE IF NOT EXISTS `endpoints` (
  ...
  `endpoint_title`              VARCHAR(255),
  `provider_domain`             VARCHAR(255),
  `provider_family`             VARCHAR(255),
  `method`                      VARCHAR(20),
  ...
  `client_interface_agnostic`   VARCHAR(20),
  `request_envelope_required`   VARCHAR(20),
  `structured_api_supported`     VARCHAR(20),
  `conversational_trigger_supported` VARCHAR(20),
  ...
  `transport_action_key`        VARCHAR(255),
  `schema_json`                 JSON,
  `schema_overlay_status`       VARCHAR(100),
  `schema_overlay_notes`        TEXT,
  `runtime_binding_profile`     JSON,
  `admin_only`                  VARCHAR(20),
  `client_allowed`              VARCHAR(20),
  `team_allowed`                VARCHAR(20),
  `writeback_scope`             VARCHAR(255),
  `created_at`  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_at`  TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `task_routes` (
  ...
  `required_variable_profile` TEXT,
  `variable_contract_group` VARCHAR(255),
  `supported_ingress_channels` TEXT,
  `requires_conversational_inference` VARCHAR(20),
  `supports_structured_api_calls` VARCHAR(20),
  `supported_model_providers` TEXT,
  `allowed_actor_roles`    TEXT,
  `allowed_governance_levels` TEXT,
  `client_allowed`         VARCHAR(20),
  `team_allowed`           VARCHAR(20),
  `admin_only`             VARCHAR(20),
  `brand_scope_enforced`   VARCHAR(20),
  `supported_languages`     TEXT,
  `translation_step_required` VARCHAR(100),
  `locale_sensitive`       VARCHAR(20),
  `created_at`  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_at`  TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `workflows` (
  ...
  `last_validated_at`     VARCHAR(100),
  `required_variable_profile` TEXT,
  `input_contract_profile` TEXT,
  `supported_ingress_channels` TEXT,
  `supports_structured_api_calls` VARCHAR(20),
  `supported_model_providers` TEXT,
  `model_adapter_required` VARCHAR(20),
  `allowed_actor_roles`    TEXT,
  `allowed_governance_levels` TEXT,
  `client_allowed`         VARCHAR(20),
  `team_allowed`           VARCHAR(20),
