...
const DOMAIN_RULES = [
  ...
  ["Platform resources & graph", /platform_graph|platform_resource|resource_recipe|resource_type|resource_adapter|contract_surface|registry_surfaces|capability|decision|intent|adaptation/i],
  ...
  ["Migration & lifecycle", /migration|database_table_lifecycle|checkpoint|validation_repair|recovery|repair_run/i],
