...
const DOMAIN_RULES = [
  ["Tenancy & identity", /tenant|membership|user|role|workspace|actor|invitation|entitlement|subscription|plan|assistance/i],
  ["Brand & business", /brand|business_activity|business_type|customer|contact|campaign|audience|persona|segment|market/i],
  ["Agents & intelligence", /agent|skill|plugin|logic|engine|model|prompt|knowledge/i],
  ["Workflow & tasks", /workflow|task|route|step|approval|job|orchestrat|execution_plan/i],
  ["Connectors & providers", /connector|connected_system|installation|credential|provider|app_integration|user_app_connection|webhook|oauth|cloudflare|hostinger|wordpress|n8n|local_gateway|device/i],
  ["Governance & authority", /policy|permission|grant|authority|quota|budget|compliance|access|rate_limit/i],
