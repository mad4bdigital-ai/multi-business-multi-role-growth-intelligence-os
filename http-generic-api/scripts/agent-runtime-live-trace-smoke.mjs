...
async function writeLiveTraceEvidence({ pool, traceId, modelRunId, providerResult, startedAt, endedAt }) {
  ...
  await writeExecutionEvidence({
    ...
    outputSummary: {
      smoke: "agent_runtime_live_trace_smoke_v2",
      ...
      brand_key: "platform_admin_control",
      business_activity_type_key: "agent_runtime_provider_smoke",
      resource_authority_status: "preview_authorized_no_target_write",
      budget_authority_status: "bounded_max_tokens_32_policy",
    ...
    runtimeEvidence: { live_provider_call: true, provider_key: providerResult.provider_key, no_external_write: true, no_secret_return: true, max_tokens_bound: 32 },
    brandEvidence: { brand_key: "platform_admin_control", brand_core_status: "not_required_for_platform_smoke", no_brand_write: true },
    businessActivityEvidence: { business_activity_type_key: "agent_runtime_provider_smoke", resolved: true, no_customer_activity_write: true },
    resourceAuthorityEvidence: { authority_status: "preview_authorized_no_target_write", resource_type: "agent_runtime_ledger", target_write: false },
    budgetAuthorityEvidence: { authority_status: "bounded", max_tokens_requested: 8, max_tokens_policy_limit: 32, spend_change: false },
