...
function main() {
  ...
  const keyScripts = listFiles(path.join(API_ROOT, "scripts"), (name) => /automation-intelligence-guard|openapi|repo-maintenance|schema-docs|surface-contract|split/.test(name));
