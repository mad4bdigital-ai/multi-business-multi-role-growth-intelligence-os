...
const MARKER_COMMAND = "node --check scripts/pr-4395-bounded-candidate-window-one-shot.mjs && python3 -m py_compile scripts/pr-4395-bounded-candidate-window-fix.py";
