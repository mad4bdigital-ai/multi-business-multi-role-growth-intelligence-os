...
for (const required of [
  /name: Hostinger Completed Build Log Evidence R3B Push/,
  /push:/,
  /branches:\n\s+- main/,
  /completed-build-log-evidence-r3b-f5c1ae88\.txt/,
  /runs-on: ubuntu-24\.04-arm/,
  /cancel-in-progress: false/,
  /permissions:\n\s+contents: read\n\s+issues: write/,
  /RUN_HOSTINGER_COMPLETED_BUILD_LOG_EVIDENCE_R3B_PUSH_F5C1AE88_V1/,
  ...
  /HOSTINGER_COMPLETED_BUILD_LOG_EVIDENCE_R3B_PUSH status=claiming/,
  /HOSTINGER_COMPLETED_BUILD_LOG_EVIDENCE_R3B_PUSH status=completed/,
...
assert.ok(markerValidation >= 0 && claim > markerValidation, "claim must follow all immutable validation");
...
console.log("Hostinger completed-build log evidence R3B push fallback contract test passed");
