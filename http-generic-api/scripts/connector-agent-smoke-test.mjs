...
async function main() {
  ...
  const requiredFiles = ["server.mjs", "browser4-adapter.mjs", "local-agent-runtime.mjs", "connector-watchdog.ps1", "connector-safe-upgrade.ps1", "db-restore-certifier.mjs", "n8n-restore-certifier.mjs"];
