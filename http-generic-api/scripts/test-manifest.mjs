...
const upstreamCommands = [
  ...
  "node test-production-recovery-operational-adapters.mjs",
...
const staticDiscoveryCommands = [
  ...
  "node test-brand-collation-boundary.mjs",
  ...
  "node test-remote-mcp-incremental-consent.mjs",
  ...
  "node test-host-breakglass-catalog.mjs",
  "node test-host-breakglass-capsule-executor.mjs",
  "node test-host-breakglass-ssh-capsule-executor.mjs",
  "node test-admin-host-breakglass-routes.mjs",
  ...
  "node test-spec018-residual-readiness-evidence.mjs",
  ...
  "node test-local-connector-tenant-identity-contract.mjs",
  ...
  "node test-surface-metadata-sql-authority.mjs",
  ...
  "node test-tenant-activation-pending-task-summary.mjs",
  ...
  "node test-tenant-published-request-contract-parity.mjs",
