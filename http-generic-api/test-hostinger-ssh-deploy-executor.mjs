...
assert(executor.includes("redactionSecrets"), "SSH output sanitizer must receive resolved secret values for defensive redaction");
assert(executor.includes("sanitizeSshOutput(stdout, redactionSecrets)"), "stdout must be scrubbed against resolved password/private key values");
assert(executor.includes("sanitizeSshOutput(stderr, redactionSecrets)"), "stderr must be scrubbed against resolved password/private key values");
