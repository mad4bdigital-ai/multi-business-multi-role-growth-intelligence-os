...
const migration = readFileSync("migrations/266_sprint68_governed_repository_intelligence_engine.sql", "utf8");
...
includesAll(releaseReadiness, [
  "266_sprint68_governed_repository_intelligence_engine.sql",
  "governed_repository_intelligence_engine_policy_v1",
