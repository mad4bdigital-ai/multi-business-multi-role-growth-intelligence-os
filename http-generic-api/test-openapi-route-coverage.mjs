...
assert(
  script.includes("canonicalOpenApiAuthority") && script.includes("frontend-runtime-routes.generated.yaml"),
  "canonical authority filtering must exclude runtime indexes and generated audience projections",
);
