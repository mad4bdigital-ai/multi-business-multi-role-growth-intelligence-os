...
const migration = readFileSync("migrations/271_sprint68_support_ticket_lifecycle_snapshot_proposal.sql", "utf8");
...
assert(releaseReadiness.includes("271_sprint68_support_ticket_lifecycle_snapshot_proposal.sql"), "release readiness must track migration 271");
...
assert(runner.includes("271_sprint68_support_ticket_lifecycle_snapshot_proposal.sql"), "governed migration runner must allowlist migration 271");
...
for (const forbidden of [
  "recordSupportTicketLifecycleSnapshot",
  "UPDATE tickets",
