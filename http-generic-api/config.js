...
export const SQL_CACHE_KEY_VERSION =
  String(process.env.SQL_CACHE_KEY_VERSION || "v2").trim() || "v2";
export const SQL_CACHE_MAX_VALUE_BYTES =
  positiveNumberEnv("SQL_CACHE_MAX_VALUE_BYTES", 1_048_576, { min: 1_024, max: 8_388_608 });
export const SQL_CACHE_OVERSIZE_COOLDOWN_SECONDS =
  positiveNumberEnv("SQL_CACHE_OVERSIZE_COOLDOWN_SECONDS", 300, { min: 0, max: 86_400 });
export const SQL_CACHE_CIRCUIT_BREAKER_SECONDS =
  positiveNumberEnv("SQL_CACHE_CIRCUIT_BREAKER_SECONDS", 15, { min: 0, max: 3_600 });
export const SQL_CACHE_SINGLE_FLIGHT_ENABLED =
  String(process.env.SQL_CACHE_SINGLE_FLIGHT_ENABLED || "TRUE").trim().toUpperCase() !== "FALSE";
export const SQL_CACHE_RUNTIME_STATE_MAX_ENTRIES =
  positiveNumberEnv("SQL_CACHE_RUNTIME_STATE_MAX_ENTRIES", 1_000, { min: 10, max: 100_000 });
...
export const SQL_CACHE_TABLE_BLOCKLIST =
  String(process.env.SQL_CACHE_TABLE_BLOCKLIST || "endpoints").trim();
...
export const SQL_CACHE_RUNTIME_POLICY_CONFIG_KEY =
  String(process.env.SQL_CACHE_RUNTIME_POLICY_CONFIG_KEY || "sql_cache_policy_v2").trim() || "sql_cache_policy_v2";
export const SQL_CACHE_POLICY_REFRESH_SECONDS =
  positiveNumberEnv("SQL_CACHE_POLICY_REFRESH_SECONDS", 15, { min: 1, max: 3_600 });
