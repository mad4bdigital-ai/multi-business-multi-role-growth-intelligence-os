...
export const RUNTIME_MIGRATION_TARGET_BINDINGS = Object.freeze({
  ...
  "20260922_local_manager_device_link_authority.sql": Object.freeze({
    migration: "20260922_local_manager_device_link_authority.sql",
    ownership_domain: "runtime",
    database_target_role: "runtime",
    credential_binding_prefix: "DB_",
    required_resources: ["local_manager_device_link_sessions"],
    mutation_class: "schema_convergence",
    traffic_policy: "normal",
    rollback_class: "forward_fix_only",
    secrets_included: false,
  }),
  "20260922_local_manager_control_templates_registry.sql": Object.freeze({
    migration: "20260922_local_manager_control_templates_registry.sql",
    ownership_domain: "runtime",
    database_target_role: "runtime",
    credential_binding_prefix: "DB_",
    required_resources: ["local_manager_control_templates"],
    mutation_class: "schema_and_seed_convergence",
    traffic_policy: "normal",
    rollback_class: "forward_fix_only",
    secrets_included: false,
  }),
