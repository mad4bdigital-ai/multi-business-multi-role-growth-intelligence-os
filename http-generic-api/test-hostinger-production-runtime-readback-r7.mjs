...
const decisionPath = path.join(repositoryRoot, '.github/scripts/production-r7-decision.mjs');
...
assert.match(decision, /trusted_ingress_attestation_required/);
assert.match(decision, /oauth_discovery_not_ready/);
