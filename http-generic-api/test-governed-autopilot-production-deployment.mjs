...
assert.match(r7, /fetch_mcp_initialize/);
assert.match(r7, /https:\/\/mcp\.mad4b\.com\/mcp/);
assert.match(r7, /"method":"initialize"/);
assert.match(r7, /trusted_ingress_attestation_required/);
assert.match(r7, /oauth_discovery_not_ready/);
assert.match(r7, /mcp_transport_not_ready/);
assert.match(r7, /const productionCurrent = identityHttpSuccess/);
assert.match(r7, /oauthDiscoveryReady/);
assert.match(r7, /mcpInitializeReady/);
assert.match(r7, /public_probe_only: true/);
assert.match(r7, /non_mutating_mcp_initialize_probe: true/);
assert.match(r7, /authenticated_request_performed: false/);
...
assert.match(r7, /mad4b\.hostinger-production-runtime-readback-r7\.v2/);
