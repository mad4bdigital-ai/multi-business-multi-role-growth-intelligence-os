...
const migration = readFileSync(new URL("./migrations/234_sprint67_repo_patch_capability_envelope_requirement.sql", import.meta.url), "utf8");
...
assert.match(runner, /234_sprint67_repo_patch_capability_envelope_requirement\.sql/);
