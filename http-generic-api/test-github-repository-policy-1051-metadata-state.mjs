...
const applyLedger = classifyLedgerState({
  readback_status: "pass",
  ledger: {
    found: true,
    migration_file: MIGRATION,
...
assert.equal(applyLedger.apply_ledger, true);
assert.equal(applyLedger.record_only_ledger, false);
...
console.log(JSON.stringify({
  ok: true,
  test: "github_repository_policy_1051_metadata_state_and_orphan_ledger_recovery",
