...
assert.match(workflow, /identity\?\.candidate_kind === 'merge_candidate'/u);
assert.match(workflow, /fullSha\.test\(source\.identity\?\.candidate_sha \|\| ''\)/u);
assert.match(workflow, /sourceHeadSha === process\.env\.EVENT_CANDIDATE_SHA/u);
...
console.log(JSON.stringify({
  ...
  cases: 28,
  merge_candidate_source_head_separation: true,
