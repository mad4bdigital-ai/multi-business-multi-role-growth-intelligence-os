...
function makePool() {
  ...
  const ctx = {
    target_write_id: "tw1",
    target_item_id: "ti1",
    remaining_scope_completion_id: "rc1",
    actual_request_id: "ar1",
    actual_capability_envelope_id: "env1",
    promotion_id: "promo1",
    insight_id: "ins1",
    ...
    secrets_included: 0,
    source_payload_sha256: "sha1",
    write_payload_json: JSON.stringify({ target_item_id: "ti1", target_surface: "development_backlog", promotion_type: "development_backlog_item" }),
    write_result_json: JSON.stringify({ target_item_id: "ti1", target_write_executed: true }),
    item_target_item_id: "ti1",
    source_target_write_id: "tw1",
    item_promotion_id: "promo1",
    item_insight_id: "ins1",
    item_target_surface: "development_backlog",
    item_promotion_type: "development_backlog_item",
    item_source_payload_sha256: "sha1",
