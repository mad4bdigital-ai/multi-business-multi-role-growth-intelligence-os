...
const migration = readFileSync("migrations/275_sprint68_support_ticket_lifecycle_snapshot_apply_binding.sql", "utf8");
...
assert(releaseReadiness.includes("275_sprint68_support_ticket_lifecycle_snapshot_apply_binding.sql"), "release readiness must track migration 275");
...
assert(runner.includes("275_sprint68_support_ticket_lifecycle_snapshot_apply_binding.sql"), "governed migration runner must allowlist migration 275");
