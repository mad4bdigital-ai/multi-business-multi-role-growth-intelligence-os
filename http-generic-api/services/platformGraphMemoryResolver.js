...
function mapAssetRow(row = {}) {
  return {
    ...
    notes_excerpt: row.notes_excerpt || null,
...
export async function resolvePlatformGraphMemory({ input = {}, graphContext = null, limit = 8 } = {}) {
  ...
  const params = [directAssetIds.length ? directAssetIds : ["__none__"], graphNodeIds.length ? graphNodeIds : ["__none__"], graphNodeIds.length ? graphNodeIds : ["__none__"], maxLimit];
