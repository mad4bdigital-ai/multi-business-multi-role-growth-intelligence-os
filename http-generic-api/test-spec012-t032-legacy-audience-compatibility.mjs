...
assert.equal(record.status, "repository_policy_and_telemetry_validated_live_metric_readback_required");
...
assert.equal(record.validation.validation_head_sha, "03381d19ab55052ea243c20ab652f683b46e4ee2");
assert.equal(record.validation.validation_run_id, 30860890407);
assert.equal(record.validation.validation_job_id, 91842398377);
...
assert.equal(record.validation.post_validation_workflow_restore_commit, "6476f688efd8fa84dd75f19fd7e347c0c7c7f221");
