...
assert.match(deployScript, /\$state\["validated_commit"\] = \$Sha/);
...
assert.match(installer, /\[switch\]\$EnableActivationGateway/);
...
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /ExpectedCommit/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /staging-schema-bundle-manifest\.json/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /mad4b\.staging\.schema-bundle-output\.v1/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /Get-FileHash -Algorithm SHA256/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /Test-GzipFile/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /Global\\Mad4bStagingSchemaImport/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /schema-import-state\.json/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /canonical_seed_status/);
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /canonical_seed_readback/);
...
assert.match(schemaImporterEntrypoint + schemaImporterLegacy, /production_accessed/);
