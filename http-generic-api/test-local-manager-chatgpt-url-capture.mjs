...
const migration = readFileSync(new URL('./migrations/234_sprint68_local_manager_chatgpt_url_capture_action.sql', import.meta.url), 'utf8');
...
assert.ok(runner.includes('234_sprint68_local_manager_chatgpt_url_capture_action.sql'));
