...
assert.match(script, /CONFIG_KEY = "audit_log_event_bus_bridge_schedule"/);
assert.match(script, /readCursor/);
assert.match(script, /writeCursor/);
assert.match(script, /last_audit_log_id/);
assert.match(script, /WHERE id > \?/);
