...
function builtInShellAllowlist() {
  return {
    ...
    platform_tasks_registry_readback: { command: process.execPath, args: ["http-generic-api/scripts/platform-tasks-registry-readback.mjs"], display_name: "Platform tasks registry readback", allow_extra_args: true, max_extra_args: 8, timeout_ms: 120000, built_in: true },
