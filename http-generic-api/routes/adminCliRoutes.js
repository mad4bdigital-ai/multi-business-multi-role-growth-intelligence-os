...
function builtInShellAllowlist() {
  return {
    ...
    capability_resolution_dry_run: { command: process.execPath, args: [CAPABILITY_RESOLUTION_DRY_RUN_SCRIPT], display_name: "Dynamic capability resolution dry-run", allow_extra_args: true, max_extra_args: 28, timeout_ms: 120000, built_in: true },
    ...
    capability_resolution_envelope_create: { command: process.execPath, args: [CAPABILITY_RESOLUTION_ENVELOPE_CREATE_SCRIPT], display_name: "Create capability resolution envelope ledger record", allow_extra_args: true, max_extra_args: 32, timeout_ms: 120000, built_in: true },
