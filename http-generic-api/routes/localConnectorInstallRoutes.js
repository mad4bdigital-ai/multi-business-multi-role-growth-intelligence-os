...
function buildInstallScript({ cfToken, connectorSecret, tunnelUrl, aliases, port }) {
  ...
  return [
    ...
    "echo CONNECTOR_BROWSER4_ENABLED=true>> \"%~dp0.env\"",
    "echo BROWSER4_ALLOWED_HOSTS=mad4b.com,n8n.mad4b.com>> \"%~dp0.env\"",
    "echo BROWSER4_WORK_DIR=D:\\n8n-data\\browser-runtime-artifacts>> \"%~dp0.env\"",
    "echo BROWSER4_JAVA_HOME=D:\\n8n-data\\browser-runtime\\jre17\\jdk-17.0.19+10-jre>> \"%~dp0.env\"",
...
function buildInstallPowerShell({ cfToken, connectorSecret, tunnelUrl, aliases, port }) {
  ...
  return [
    ...
    "}",
    "",
    "# 2. Download connector agent via manifest + sha256 verification",
