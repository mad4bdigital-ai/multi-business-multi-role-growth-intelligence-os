...
assert(transitionWindow.includes('composition_mode: "inline"'), "deploy transition must converge to the canonical inline precise contract");
...
assert(registrySource.includes("composition_mode: inline"), "deploy precise registry must inline the canonical path item into root OpenAPI for route coverage and downstream consumers");
