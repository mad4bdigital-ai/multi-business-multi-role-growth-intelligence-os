...
const sanitized = sanitizeConnectorResult({ ok: true, action: 'inspect_site', run_key: 'abc', target_host: 'n8n.mad4b.com', checks: ['snapshot'], exit_code: 0, status: 'completed', artifacts: { snapshot_path: 'D:/x/snapshot.txt' }, stdout_preview: 'x'.repeat(3000), stderr_preview: 'y'.repeat(3000), secret: 'should not be copied' });
