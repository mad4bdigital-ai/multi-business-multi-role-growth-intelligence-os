...
assert.equal(connectorEndpoint('essam-pc', 'http://localhost:8080/'), 'http://localhost:8080/connector/essam-pc/browser4');
...
assert(readFileSync('routes/browserRuntimeRoutes.js', 'utf8').includes('/browser-runtime/inspect-site/run'));
assert(readFileSync('routes/connectorProxyRoutes.js', 'utf8').includes('/connector/:device_id/browser4'));
