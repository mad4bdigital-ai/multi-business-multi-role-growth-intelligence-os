-- Sprint 69 / Spec 007: governed platform resource authority grant tool.
-- Registers a dry-run-default admin tool for bounded, TTL-limited resource authority grants.
-- No migration application is performed by this file alone.
