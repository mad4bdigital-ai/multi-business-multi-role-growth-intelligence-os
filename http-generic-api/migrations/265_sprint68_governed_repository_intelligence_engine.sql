...
--
-- Adds repository development governance to the generic platform_resource_*
-- model. V1 is registry/plan-only and does not enable comments, labels,
-- closing PRs, merging, patching, force-push, or migration apply.
--
