...
CREATE OR REPLACE VIEW `v_session_insight_capability_dispatch_review_queue` AS
SELECT
...
CREATE OR REPLACE VIEW `v_session_insight_capability_dispatch_review_issues` AS
SELECT
  d.dispatch_dry_run_id,
  d.request_gate_id,
  d.capability_plan_id,
...
FROM `session_insight_capability_dispatch_review_events` e
...
CREATE OR REPLACE VIEW `v_session_insight_capability_actual_request_readiness` AS
SELECT
  d.dispatch_dry_run_id,
  d.request_gate_id,
  d.capability_plan_id,
