-- 1011_sprint69_sql_only_runtime_auth_schema.sql
...
VALUES
  ('0786a17f-f06c-47a9-9245-906608af5bf6','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','analytics_admin_api','google_analytics_admin','platform_oauth2_runtime','platform_managed:analytics_admin_api_oauth2','google','analytics_admin_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('27ddfd4f-2af9-46a1-aa91-59d4dd69288f','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','analytics_data_api','google_analytics','platform_oauth2_runtime','platform_managed:analytics_data_api_oauth2','google','analytics_data_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('90189339-f99a-4a75-992f-4e3f633235b9','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','google_docs_api','google_docs','platform_oauth2_runtime','platform_managed:google_docs_api_oauth2','google','google_docs_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('8a6cb94e-6db5-4c3a-9b5f-90168f000001','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','google_drive_api','google_drive','platform_oauth2_runtime','platform_managed:google_drive_api_oauth2','google','google_drive_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('d7d49689-2dbc-4881-a2f1-1d36b689d243','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','google_sheets_api','google_sheets','platform_oauth2_runtime','platform_managed:google_sheets_api_oauth2','google','google_sheets_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('4654d081-ae77-4a0e-a766-964b23f39e95','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','googleads_api','google_ads','platform_oauth2_runtime','platform_managed:googleads_api_oauth2','google','googleads_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('833af828-e733-45cf-a25d-ecc19f77db26','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','searchads360_api','search_ads_360','platform_oauth2_runtime','platform_managed:searchads360_api_oauth2','google','searchads360_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('1f99678a-513f-4923-84b8-27a0ca7509db','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','searchconsole_api','google_search_console','platform_oauth2_runtime','platform_managed:searchconsole_api_oauth2','google','searchconsole_api',250,'active','migration_1011_sql_only_runtime_contracts'),
  ('b33ee3ea-1f24-402a-8949-f74bd1cfe0bf','00000000-0000-0000-0000-000000000000','platform','growth_intelligence_platform','tagmanager_api','google_tag_manager','platform_oauth2_runtime','platform_managed:tagmanager_api_oauth2','google','tagmanager_api',250,'active','migration_1011_sql_only_runtime_contracts')
ON DUPLICATE KEY UPDATE
  `owner_type`=VALUES(`owner_type`),
  `owner_id`=VALUES(`owner_id`),
