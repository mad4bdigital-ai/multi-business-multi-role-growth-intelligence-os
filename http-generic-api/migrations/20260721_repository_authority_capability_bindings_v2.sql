...
ON DUPLICATE KEY UPDATE
  ...
  lifecycle_status='active', metadata_json=VALUES(metadata_json), capability_version=repository_capability_bindings.capability_version+1,
...
ON DUPLICATE KEY UPDATE precedence=VALUES(precedence), configuration_json=VALUES(configuration_json),
  lifecycle_status='active', layer_version=repository_capability_policy_layers.layer_version+1, lock_version=repository_capability_policy_layers.lock_version+1,
