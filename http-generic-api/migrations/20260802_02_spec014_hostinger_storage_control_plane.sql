-- Spec 014: Governed Hostinger Storage Orchestration — Wave 2 Control Plane
-- Additive migration candidate promoted into the governed runtime migration sequence.
-- Depends on 20260802_01_spec014_hostinger_storage_foundation.sql.
...
-- lease_history_json remains reserved for the separately governed history-appending service.
-- Cyclic current_plan/current_run/current_lease foreign keys remain deferred.
