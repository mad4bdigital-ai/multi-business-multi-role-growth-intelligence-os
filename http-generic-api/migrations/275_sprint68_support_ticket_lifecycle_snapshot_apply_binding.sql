...
-- Registry-only: no ticket mutation, workflow dispatch, approval decision,
-- external send/write, provider call, credential payload read, spend change,
-- deploy/publish, or secrets.
