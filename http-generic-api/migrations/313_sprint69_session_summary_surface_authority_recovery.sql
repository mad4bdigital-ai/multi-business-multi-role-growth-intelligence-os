-- Sprint 69: recover required SQL-backed session summary and graph-memory surfaces.
-- Root cause: migrations 134 and 139 existed in source but were absent from the
-- governed migration ledger, leaving session-summary closeout blocked by surface_not_found.
-- Additive and idempotent. No provider calls. No credential payload reads.
