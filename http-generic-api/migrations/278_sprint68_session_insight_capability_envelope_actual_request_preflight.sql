...
CREATE OR REPLACE VIEW `v_session_insight_actual_request_preflight_issues` AS
SELECT
...
CREATE OR REPLACE VIEW `v_session_insight_actual_request_preflight_readiness` AS
SELECT
