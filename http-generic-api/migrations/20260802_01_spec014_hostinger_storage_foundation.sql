-- Spec 014: Governed Hostinger Storage Orchestration — Wave 1 Foundation
...
-- External FK intents for tenants.id, workspaces.id, and platform_resources.id remain
-- deferred until exact live parent type/collation readback is available in the apply cycle.
