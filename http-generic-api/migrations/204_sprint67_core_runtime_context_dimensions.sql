...
CREATE OR REPLACE VIEW v_core_runtime_context_dimension_coverage AS
SELECT 'audit_log' AS table_name, COUNT(*) AS total_rows,
       SUM(tenant_id IS NOT NULL) AS tenant_rows, SUM(user_id IS NOT NULL) AS user_rows,
       SUM(actor_id IS NOT NULL) AS actor_rows, SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL) AS brand_rows,
       SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL) AS workspace_rows,
       SUM(correlation_id IS NOT NULL) AS correlation_rows, SUM(execution_context_json IS NOT NULL) AS context_json_rows
FROM audit_log
UNION ALL SELECT 'telemetry_spans', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM telemetry_spans
UNION ALL SELECT 'session_events', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(payload_json IS NOT NULL) FROM session_events
UNION ALL SELECT 'gpt_session_turns', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM gpt_session_turns
UNION ALL SELECT 'workflow_runs', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM workflow_runs
UNION ALL SELECT 'step_runs', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM step_runs
UNION ALL SELECT 'intent_resolutions', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM intent_resolutions
UNION ALL SELECT 'execution_plans', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM execution_plans
UNION ALL SELECT 'platform_engine_execution_runs', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM platform_engine_execution_runs
UNION ALL SELECT 'local_gateway_tool_call_log', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM local_gateway_tool_call_log
UNION ALL SELECT 'approval_holds', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM approval_holds
UNION ALL SELECT 'sink_dispatch_log', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM sink_dispatch_log
UNION ALL SELECT 'platform_graph_query_log', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM platform_graph_query_log
UNION ALL SELECT 'repo_ingestion_jobs', COUNT(*), SUM(tenant_id IS NOT NULL), SUM(user_id IS NOT NULL), SUM(actor_id IS NOT NULL), SUM(brand_id IS NOT NULL OR brand_key IS NOT NULL), SUM(workspace_id IS NOT NULL OR workspace_key IS NOT NULL), SUM(correlation_id IS NOT NULL), SUM(execution_context_json IS NOT NULL) FROM repo_ingestion_jobs;
