...
(
  ...
  NULL,
  'credentials,lifecycle,promotion,tenant_binding,read_write,no_secrets,no_token_returned,no_secret_copy,requires_approval,preflight_required,admin,scope_gated',
  1,
  257
)
