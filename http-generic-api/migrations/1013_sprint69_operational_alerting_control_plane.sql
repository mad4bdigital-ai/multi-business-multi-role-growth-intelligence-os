...
('activation_operational_attention_sync_api','Synchronize Unified Operational Alerts','Evaluate live SQL evidence sources, upsert alert lifecycle rows, auto-resolve disappeared automatic alerts, queue in-app notifications, and return a same-cycle complete readback. No provider calls or external sends.','POST','/activation/operational-attention/sync',JSON_ARRAY(),JSON_OBJECT('type','object','additionalProperties',false,'properties',JSON_OBJECT('lookback_hours',JSON_OBJECT('type','integer','minimum',1,'maximum',2160,'default',168),'requested_by',JSON_OBJECT('type','string'))),NULL,'admin,activation,alerts,sync,state_changing,sql_only,in_app_notification,readback,same_cycle_readback,no_provider_call,no_external_send,no_secrets',1,11874),
('activation_operational_alert_lifecycle_api','Update Operational Alert Lifecycle','Acknowledge, investigate, resolve, ignore, or reopen one operational alert with actor and note readback.','POST','/activation/operational-attention/{alertId}/lifecycle',JSON_ARRAY('alertId'),JSON_OBJECT('type','object','required',JSON_ARRAY('lifecycle_status'),'additionalProperties',false,'properties',JSON_OBJECT('lifecycle_status',JSON_OBJECT('type','string','enum',JSON_ARRAY('open','acknowledged','investigating','resolved','ignored')),'actor',JSON_OBJECT('type','string'),'note',JSON_OBJECT('type','string'))),NULL,'admin,activation,alerts,lifecycle,state_changing,audited,readback,same_cycle_readback,no_secrets',1,11875)
ON DUPLICATE KEY UPDATE
