...
for (const migration of migrations) {
  ...
  const escapedFile = migration.file.replace(/[.*+?^${}()|[\]\\]/g,"\\  assert(runner.includes(`"${migration.file}"`),`${migration.file} must be bootstrap-authorized before self-authorization exists`);
