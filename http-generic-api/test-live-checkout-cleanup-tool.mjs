...
assert.match(script, /async function loadCapabilityEnvelopeDeps\(\)/);
assert.match(script, /import\("\.\.\/capabilityResolutionEnvelopeGuard\.js"\)/);
assert.match(script, /import\("\.\.\/db\.js"\)/);
assert.match(script, /async function loadAuditDeps\(\)/);
assert.match(script, /import\("\.\.\/auditLogger\.js"\)/);
