...
assert.match(readinessDiagnosticWrapper, /runbook_key: 'database\.full_inspection'/);
assert.match(readinessDiagnosticWrapper, /action: 'dry_run'/);
assert.match(readinessDiagnosticWrapper, /target_source: 'host_local_role_env'/);
assert.match(readinessDiagnosticWrapper, /target_key: 'production-runtime'/);
assert.match(readinessDiagnosticWrapper, /migration_selected: false/);
assert.match(readinessDiagnosticWrapper, /unsafe_inspection_receipt_rejected/);
assert.match(readinessDiagnosticWrapper, /database_mutation_performed: false/);
assert.match(readinessDiagnosticWrapper, /migration_apply_performed: false/);
assert.match(readinessDiagnosticWrapper, /grant_mutation_performed: false/);
assert.match(readinessDiagnosticWrapper, /workflow_dispatch_performed: false/);
assert.match(readinessDiagnosticWrapper, /read_only: true/);
assert.match(readinessDiagnosticWrapper, /credentials_included: false/);
