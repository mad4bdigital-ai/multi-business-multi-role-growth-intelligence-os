...
assert(routesSource.includes("tenant_id, user_id") && !routesSource.includes("tenant_id, user_id, connection_id, and brand_key"), "route must allow target-only credential binding diagnostics without requiring connection_id");
