  ...
  try {
    ...
    await conn.query(
      ...
      [
        ...
        snapshotCandidate.scope_type || "ticket",
        snapshotCandidate.scope_id || ticketId,
        snapshotCandidate.tenant_id || null,
        snapshotCandidate.workspace_id || null,
        snapshotCandidate.brand_key || null,
        snapshotCandidate.subject_key || `ticket:${ticketId}`,
    ...
    await conn.query(
      ...
      [
        ...
        recommendationCandidate.scope_type || "ticket",
        recommendationCandidate.scope_id || ticketId,
