...
export async function writeExecutionEvidence({
  ...
  providerFamily = null,
  resourceAuthorityBindingId = null,
  budgetAuthorityId = null,
  engineKey = null,
  enginePolicyKey = null,
  modelKey = null,
  ...
  logicPackKey = null,
  brandEvidence = null,
  businessActivityEvidence = null,
  businessTypeEvidence = null,
  connectedSystemEvidence = null,
  permissionEvidence = null,
  resourceAuthorityEvidence = null,
  budgetAuthorityEvidence = null,
  engineEvidence = null,
  modelEvidence = null,
  logicEvidence = null,
  ...
  const contextDimensions = {
    ...
    brand_name: pickContext(contextObjects, brandName, ["brand_name", "brandName"]),
    brand_core_status: pickContext(contextObjects, brandCoreStatus, ["brand_core_status", "brandCoreStatus", "brand_core_ready", "brandCoreReady"]),
    brand_core_asset_keys: compactList(firstNonEmpty(brandCoreAssetKeys, ...contextObjects.map((source) => source.brand_core_asset_keys || source.brandCoreAssetKeys || source.brand_core_assets || source.brandCoreAssets)), 1000),
    ...
    business_activity_type_key: pickContext(contextObjects, businessActivityTypeKey, ["business_activity_type_key", "businessActivityTypeKey", "business_activity_key", "businessActivityKey"]),
    activity_key: pickContext(contextObjects, activityKey, ["activity_key", "activityKey"]),
    business_type_key: pickContext(contextObjects, businessTypeKey, ["business_type_key", "businessTypeKey"]),
    knowledge_profile_key: pickContext(contextObjects, knowledgeProfileKey, ["knowledge_profile_key", "knowledgeProfileKey"]),
    ...
    installation_id: pickContext(contextObjects, installationId, ["installation_id", "installationId"]),
    permission_grant_id: pickContext(contextObjects, permissionGrantId, ["permission_grant_id", "permissionGrantId", "grant_id", "grantId"]),
    permission_key: pickContext(contextObjects, permissionKey, ["permission_key", "permissionKey"]),
    connector_family: pickContext(contextObjects, connectorFamily, ["connector_family", "connectorFamily"]),
    provider_family: pickContext(contextObjects, providerFamily, ["provider_family", "providerFamily"]),
    resource_authority_binding_id: pickContext(contextObjects, resourceAuthorityBindingId, ["resource_authority_binding_id", "resourceAuthorityBindingId", "authority_binding_id", "authorityBindingId"]),
    budget_authority_id: pickContext(contextObjects, budgetAuthorityId, ["budget_authority_id", "budgetAuthorityId", "authority_id", "authorityId"]),
    engine_key: pickContext(contextObjects, engineKey, ["engine_key", "engineKey"]),
    engine_policy_key: pickContext(contextObjects, enginePolicyKey, ["engine_policy_key", "enginePolicyKey"]),
    model_key: pickContext(contextObjects, modelKey, ["model_key", "modelKey"]),
    model_provider_key: pickContext(contextObjects, modelProviderKey, ["model_provider_key", "modelProviderKey", "provider_key", "providerKey"]),
    model_run_id: pickContext(contextObjects, modelRunId, ["model_run_id", "modelRunId"]),
    logic_key: pickContext(contextObjects, logicKey, ["logic_key", "logicKey"]),
    logic_pack_key: pickContext(contextObjects, logicPackKey, ["logic_pack_key", "logicPackKey"]),
    ...
    entry_type: compact(entryType, 255),
    source_layer: compact(sourceLayer, 255),
    execution_mode: compact(executionMode, 255),
  ...
  const runtimeEvidenceEnvelope = {
    ...
    surfaces: {
      ...
      connected_system_id: contextDimensions.connected_system_id,
      installation_id: contextDimensions.installation_id,
      permission_grant_id: contextDimensions.permission_grant_id,
      permission_key: contextDimensions.permission_key,
      connector_family: contextDimensions.connector_family,
      provider_family: contextDimensions.provider_family,
      resource_authority_binding_id: contextDimensions.resource_authority_binding_id,
      budget_authority_id: contextDimensions.budget_authority_id,
      engine_key: contextDimensions.engine_key,
      engine_policy_key: contextDimensions.engine_policy_key,
      model_key: contextDimensions.model_key,
      model_provider_key: contextDimensions.model_provider_key,
      model_run_id: contextDimensions.model_run_id,
      logic_key: contextDimensions.logic_key,
      logic_pack_key: contextDimensions.logic_pack_key,
    },
