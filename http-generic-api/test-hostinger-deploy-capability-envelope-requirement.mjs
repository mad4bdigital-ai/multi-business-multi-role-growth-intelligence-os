...
assert.match(executor, /extractCapabilityEnvelopeId/);
assert.match(executor, /resolveCapabilityEnvelopeForHostingerDeploy/);
assert.match(executor, /capability_resolution_envelope_ledger/);
assert.match(executor, /capability_resolution_envelope_required/);
assert.match(executor, /ready_for_dispatch/);
assert.match(executor, /dispatch_allowed/);
assert.match(executor, /approval_required/);
assert.match(executor, /blocking_gap_count/);
assert.match(executor, /capability_resolution_envelope_commit_mismatch/);
