...
assert(routes.includes('next_step: "approval_decision_required_before_execute"'), "approval request must identify gated future execution");
assert(routes.includes('/me/infrastructure/ssh/cli/approval-requests/:request_id/decision'), "approval request must still hand off to approval decision before execute");
