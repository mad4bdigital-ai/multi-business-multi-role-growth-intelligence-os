...
assert(routes.includes('/me/infrastructure/ssh/cli/approval-requests/:request_id/decision'), "approval request must hand off to the governed approval decision route before execute");
