...
const migration = readFileSync(new URL("./migrations/222_sprint67_gpt_session_conversation_refs.sql", import.meta.url), "utf8");
...
assert.ok(runner.includes("222_sprint67_gpt_session_conversation_refs.sql"));
assert.ok(readiness.includes("222_sprint67_gpt_session_conversation_refs.sql"));
