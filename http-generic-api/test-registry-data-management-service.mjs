...
assert(migration.includes("admin_data_table_row_create"), "migration must register admin create tool");
assert(migration.includes("tenant_data_table_row_create"), "migration must register tenant create tool");
