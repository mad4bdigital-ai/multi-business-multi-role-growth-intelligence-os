...
const lifecycleCore = readFileSync("githubRepositoryLifecycleCore.js", "utf8");
const lifecycleContractSource = `${lifecycle}\n${lifecycleCore}`;
...
assert.match(lifecycle, /githubRepositoryLifecycleCore\.js/);
assert.match(lifecycle, /createRepositoryAuthorityCheckedFetch/);
assert.doesNotMatch(toolsRoute, /githubRepositoryLifecycleCore\.js/);
assert.match(lifecycleContractSource, /github_pr_finalize_gate_blocked/);
assert.match(lifecycleContractSource, /github_pr_finalize_sha_mismatch/);
assert.match(lifecycleContractSource, /github_pr_finalize_confirmation_required/);
assert.match(lifecycleContractSource, /github_branch_delete_sha_mismatch/);
assert.match(lifecycleContractSource, /github_branch_delete_open_pr/);
assert.match(lifecycleContractSource, /github_branch_delete_readback_failed/);
assert.match(lifecycleContractSource, /github_change_set_base_moved/);
assert.match(lifecycleContractSource, /github_change_set_branch_not_pristine/);
assert.match(lifecycleContractSource, /github_change_set_readback_failed/);
