...
function toSafeContribution(row = {}) {
  return {
    ...
    manifest_json: typeof row.manifest_json === "string" ? JSON.parse(row.manifest_json || "{}") : (row.manifest_json || {}),
    protocol_bindings_json: typeof row.protocol_bindings_json === "string" ? JSON.parse(row.protocol_bindings_json || "[]") : (row.protocol_bindings_json || []),
    action_bindings_json: typeof row.action_bindings_json === "string" ? JSON.parse(row.action_bindings_json || "[]") : (row.action_bindings_json || []),
    credential_policy_json: typeof row.credential_policy_json === "string" ? JSON.parse(row.credential_policy_json || "{}") : (row.credential_policy_json || {}),
    validation_report_json: typeof row.validation_report_json === "string" ? JSON.parse(row.validation_report_json || "{}") : (row.validation_report_json || {}),
    notes: row.notes || "",
